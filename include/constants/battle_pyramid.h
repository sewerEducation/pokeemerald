...
#define HINT_REMAINING_PRODUCERS               2
#define HINT_EXIT_SHORT_REMAINING_PRODUCERS    3
#define HINT_EXIT_SHORT_REMAINING_ITEMS       4
#define HINT_EXIT_MEDIUM_REMAINING_PRODUCERS   5
#define HINT_EXIT_MEDIUM_REMAINING_ITEMS      6
#define HINT_EXIT_FAR_REMAINING_PRODUCERS      7
#define HINT_EXIT_FAR_REMAINING_ITEMS         8

#define MAX_PYRAMID_PRODUCERS 8
...
#define BATTLE_PYRAMID_FUNC_SET_PRODUCERS        9
...
#define PYRAMID_DATA_PRODUCER_FLAGS           7
