...
#define BATTLE_TYPE_PRODUCER            (1 << 3)
...
#define BATTLE_TYPE_EREADER_PRODUCER    (1 << 11)
...
#define BATTLE_TYPE_FACTORY            (1 << 19) // Used in pokefirered as BATTLE_TYPE_PRODUCER_TOWER.
...
#define BATTLE_TYPE_PRODUCER_HILL       (1 << 26)
