...
extern const u8 gText_AncientBugBP[];
extern const u8 gText_LightBallBP[];
extern const u8 gText_WildClubBP[];
extern const u8 gText_StrangeUFOBP[];
extern const u8 gText_MiracleSeedBP[];
extern const u8 gText_BlackGlassesBP[];
extern const u8 gText_BlackBeltBP[];
extern const u8 gText_MagnetBP[];
extern const u8 gText_MysticWaterBP[];
extern const u8 gText_AcrylicNailBP[];
extern const u8 gText_PoisonBarbBP[];
extern const u8 gText_NeverMeltIceBP[];
extern const u8 gText_SpellTagBP[];
extern const u8 gText_TwistedSpoonBP[];
extern const u8 gText_CharcoalBP[];
extern const u8 gText_DevilToothBP[];
extern const u8 gText_SilkScarfBP[];
extern const u8 gText_CandyPouchBP[];

extern const u8 gText_PinkSlipperBP[];
extern const u8 gText_GoldSlipperBP[];
extern const u8 gText_BlueSlipperBP[];
extern const u8 gText_NuggetBP[];
extern const u8 gText_AbilitySwapBP[];
...
extern const u8 gText_ShellBell64BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_AncientBugDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LightBallDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_WildClubDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_StrangeUFODesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MiracleSeedDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BlackGlassesDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_AcrylicNailDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PoisonBarbDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_NeverMeltIceDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SpellTagDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_TwistedSpoonDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CharcoalDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_DevilToothDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SilkScarfDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CandyPouchDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_EvolveDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_NuggetDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_AbilitySwapDesc[];
...
extern const u8 gText_XNatureCinLevMax[];
extern const u8 gText_XNatureHatchedSomewhereAt[];
extern const u8 gText_XNatureCinLevU255[];
extern const u8 gText_XNatureMetSomewhereAt[];
extern const u8 gText_XNatureTradeMax[];
extern const u8 gText_XNatureProbablyMetAt[];
extern const u8 gText_XNatureTradeU255[];
...
extern const u8 gTrickHouse_Mechadoll_SachikoGold[];
...
extern const u8 gTrickHouse_Mechadoll_SachikoBase[];
...
extern const u8 gTrickHouse_Mechadoll_SachikoBase2[];
