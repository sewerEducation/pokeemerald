...
static const struct CompressedTilesPal sBerryPicTable[] =
{
    ...
    [ITEM_TO_BERRY(ITEM_SPICE_APPLE)   - 1] = {gBerryPic_Figy,   gBerryPalette_Figy},
    [ITEM_TO_BERRY(ITEM_DRY_APPLE)   - 1] = {gBerryPic_Wiki,   gBerryPalette_Wiki},
    [ITEM_TO_BERRY(ITEM_SWEET_APPLE)   - 1] = {gBerryPic_Mago,   gBerryPalette_Mago},
    [ITEM_TO_BERRY(ITEM_BITTER_APPLE)  - 1] = {gBerryPic_Aguav,  gBerryPalette_Aguav},
    [ITEM_TO_BERRY(ITEM_SOUR_APPLE) - 1] = {gBerryPic_Iapapa, gBerryPalette_Iapapa},
    ...
    [ITEM_TO_BERRY(ITEM_ATK_ENERGY) - 1] = {gBerryPic_Liechi, gBerryPalette_Liechi},
    [ITEM_TO_BERRY(ITEM_DEF_ENERGY) - 1] = {gBerryPic_Ganlon, gBerryPalette_Ganlon},
    [ITEM_TO_BERRY(ITEM_SPEED_ENERGY)  - 1] = {gBerryPic_Salac,  gBerryPalette_Salac},
    [ITEM_TO_BERRY(ITEM_SPATK_ENERGY) - 1] = {gBerryPic_Petaya, gBerryPalette_Petaya},
    [ITEM_TO_BERRY(ITEM_SPDEF_ENERGY) - 1] = {gBerryPic_Apicot, gBerryPalette_Apicot},
    [ITEM_TO_BERRY(ITEM_CRIT_ENERGY) - 1] = {gBerryPic_Lansat, gBerryPalette_Lansat},
    [ITEM_TO_BERRY(ITEM_RANDO_ENERGY)  - 1] = {gBerryPic_Starf,  gBerryPalette_Starf},
