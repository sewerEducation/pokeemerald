...
static const struct SearchOptionText sDexSearchTypeOptions[NUMBER_OF_MON_TYPES + 1] = // + 2 for "None" and terminator, - 1 for Mystery
{
    ...
    {gText_DexEmptyString, gTypeNames[TYPE_GAL]},
    {gText_DexEmptyString, gTypeNames[TYPE_TOXIC]},
    {gText_DexEmptyString, gTypeNames[TYPE_ROCK]},
    {gText_DexEmptyString, gTypeNames[TYPE_WILD]},
    {gText_DexEmptyString, gTypeNames[TYPE_BUG]},
    {gText_DexEmptyString, gTypeNames[TYPE_DEVIL]},
    {gText_DexEmptyString, gTypeNames[TYPE_METAL]},
    {gText_DexEmptyString, gTypeNames[TYPE_HOT]},
    {gText_DexEmptyString, gTypeNames[TYPE_OCEAN]},
    {gText_DexEmptyString, gTypeNames[TYPE_NATURE]},
    {gText_DexEmptyString, gTypeNames[TYPE_ANGEL]},
    {gText_DexEmptyString, gTypeNames[TYPE_ESPER]},
    {gText_DexEmptyString, gTypeNames[TYPE_COLD]},
