...
static const u16 sPrizeListRoar[]        = {ITEM_TM05_ROAR,        ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
...
static const u16 sPrizeListToxic[]       = {ITEM_TM06_TOXIC,       ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
...
static const u16 sPrizeListAttract[]     = {ITEM_TM45_ATTRACT,     ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
