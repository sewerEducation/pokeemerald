...
static const u16 sPrizeListRareCandy1[]  = {ITEM_RARE_CANDY,       ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListLuxuryBall1[] = {ITEM_FANCY_TICKET,     ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListMaxRevive1[]  = {ITEM_CARBOS,           ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListMaxEther1[]   = {ITEM_ZINC,             ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListElixir1[]     = {ITEM_HP_UP,            ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListRoar[]        = {ITEM_TM05_SPIKES,        ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListSludgeBomb[]  = {ITEM_TM36_SLUDGE_BOMB, ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListToxic[]       = {ITEM_TM06_HYPER_VOICE,       ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListSunnyDay[]    = {ITEM_TM11_SUNNY_DAY,   ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListEarthQuake[]  = {ITEM_TM26_EARTHQUAKE,  ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};

static const u16 sPrizeListRareCandy2[]  = {ITEM_RARE_CANDY,       ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListLuxuryBall2[] = {ITEM_FANCY_TICKET,     ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListMaxRevive2[]  = {ITEM_CARBOS,           ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListMaxEther2[]   = {ITEM_ZINC,             ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListElixir2[]     = {ITEM_HP_UP,            ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListBrickBreak[]  = {ITEM_TM31_BRICK_BREAK, ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListTorment[]     = {ITEM_TM41_TORMENT,     ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListSkillSwap[]   = {ITEM_TM48_SKILL_SWAP,  ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListGigaDrain[]   = {ITEM_TM19_GIGA_DRAIN,  ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
static const u16 sPrizeListAttract[]     = {ITEM_TM45_SLEEP_TALK,     ITEM_ORAN_BERRY, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_POKE_DOLL, ITEM_SR_TICKET};
...
static u16 GetPrizeItemId(void)
{
    ...
    if (minutes < 12)
        ...
        id = 1; // ITEM_ORAN_BERRY
    else if (minutes < 14)
        id = 2; // ITEM_MAX_POTION
    else if (minutes < 16)
        id = 3; // ITEM_MAX_REVIVE
    else if (minutes < 18)
        id = 4; // ITEM_POKE_DOLL
    else
        id = 5; // ITEM_SR_TICKET
