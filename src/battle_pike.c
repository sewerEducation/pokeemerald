...
static const u16 sNPCSpeeches[][EASY_CHAT_BATTLE_WORDS_COUNT] =
{
    ...
    {EC_WORD_OH, EC_WORD_NO, EC_WORD_EXCL, EC_WORD_NOT, EC_WORD_ANOTHER, EC_WORD_PRODUCER},
    ...
    {EC_WORD_A, EC_WORD_PRODUCER, EC_WORD_AFTER, EC_WORD_ANOTHER, EC_WORD_ELLIPSIS, EC_EMPTY_WORD},
    {EC_WORD_DO, EC_WORD_YOU, EC_WORD_LIKE, EC_WORD_STEEL, EC_WORD_POKEMON, EC_WORD_QUES},
    {EC_WORD_EVERY, EC_WORD_PRODUCER, EC_WORD_HERE, EC_WORD_IS, EC_WORD_TOO_WEAK, EC_EMPTY_WORD},
...
static void (* const sBattlePikeFunctions[])(void) =
{
    ...
    [BATTLE_PIKE_FUNC_CLEAR_PRODUCER_IDS]       = ClearPikeTrainerIds,
    [BATTLE_PIKE_FUNC_GET_PRODUCER_INTRO]       = BufferTrainerIntro,
...
static void BufferTrainerIntro(void)
{
    ...
    {
        if (gTrainerBattleOpponent_B < FRONTIER_PRODUCERS_COUNT)
