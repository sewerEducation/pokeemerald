...
{
    SPECIES_TO_HOENN(UZUKIBASE),
    SPECIES_TO_HOENN(UZUKIBLUE),
    SPECIES_TO_HOENN(UZUKIGOLD),
    SPECIES_TO_HOENN(UZUKIPINK),
    SPECIES_TO_HOENN(RINBASE),
    SPECIES_TO_HOENN(RINBLUE),
    SPECIES_TO_HOENN(RINGOLD),
    SPECIES_TO_HOENN(RINPINK),
    SPECIES_TO_HOENN(MIOBASE),
    SPECIES_TO_HOENN(MIOBLUE),
    SPECIES_TO_HOENN(MIOGOLD),
    SPECIES_TO_HOENN(MIOPINK),
    SPECIES_TO_HOENN(MIRIABASE),
    SPECIES_TO_HOENN(MIRIABLUE),
    SPECIES_TO_HOENN(MIRIAGOLD),
    SPECIES_TO_HOENN(MIRIAPINK),
    SPECIES_TO_HOENN(KAORUBASE),
    SPECIES_TO_HOENN(KAORUBLUE),
    SPECIES_TO_HOENN(KAORUGOLD),
    SPECIES_TO_HOENN(KAORUPINK),
    SPECIES_TO_HOENN(RIINABASE),
    SPECIES_TO_HOENN(RIINABLUE),
    SPECIES_TO_HOENN(RIINAGOLD),
    SPECIES_TO_HOENN(RIINAPINK),
    SPECIES_TO_HOENN(NANAMIBASE),
    SPECIES_TO_HOENN(NANAMIBLUE),
    SPECIES_TO_HOENN(NANAMIGOLD),
    SPECIES_TO_HOENN(NANAMIPINK),
    SPECIES_TO_HOENN(ATSUMIBASE),
    SPECIES_TO_HOENN(ATSUMIBLUE),
    SPECIES_TO_HOENN(ATSUMIGOLD),
    SPECIES_TO_HOENN(ATSUMIPINK),
    SPECIES_TO_HOENN(KOZUEBASE),
    SPECIES_TO_HOENN(KOZUEBLUE),
    SPECIES_TO_HOENN(KOZUEGOLD),
    SPECIES_TO_HOENN(KOZUEPINK),
    SPECIES_TO_HOENN(NINABASE),
    SPECIES_TO_HOENN(NINABLUE),
    SPECIES_TO_HOENN(NINAGOLD),
    SPECIES_TO_HOENN(NINAPINK),
    SPECIES_TO_HOENN(SACHIKOBASE),
    SPECIES_TO_HOENN(SACHIKOBLUE),
    SPECIES_TO_HOENN(SACHIKOGOLD),
    SPECIES_TO_HOENN(SACHIKOPINK),
    SPECIES_TO_HOENN(LAYLABASE),
    SPECIES_TO_HOENN(LAYLABLUE),
    SPECIES_TO_HOENN(LAYLAGOLD),
    SPECIES_TO_HOENN(LAYLAPINK),
    SPECIES_TO_HOENN(REINABASE),
    SPECIES_TO_HOENN(REINABLUE),
    SPECIES_TO_HOENN(REINAGOLD),
    SPECIES_TO_HOENN(REINAPINK),
    SPECIES_TO_HOENN(MOMOKABASE),
    SPECIES_TO_HOENN(MOMOKABLUE),
    SPECIES_TO_HOENN(MOMOKAGOLD),
    SPECIES_TO_HOENN(MOMOKAPINK),
    SPECIES_TO_HOENN(ARISUBASE),
    SPECIES_TO_HOENN(ARISUBLUE),
    SPECIES_TO_HOENN(ARISUGOLD),
    SPECIES_TO_HOENN(ARISUPINK),
    SPECIES_TO_HOENN(AIRIBASE),
    SPECIES_TO_HOENN(AIRIBLUE),
    SPECIES_TO_HOENN(AIRIGOLD),
    SPECIES_TO_HOENN(AIRIPINK),
    SPECIES_TO_HOENN(MINAMIBASE),
    SPECIES_TO_HOENN(MINAMIBLUE),
    SPECIES_TO_HOENN(MINAMIGOLD),
    SPECIES_TO_HOENN(MINAMIPINK),
    SPECIES_TO_HOENN(ANASTASIABASE),
    SPECIES_TO_HOENN(ANASTASIABLUE),
    SPECIES_TO_HOENN(ANASTASIAGOLD),
    SPECIES_TO_HOENN(ANASTASIAPINK),
    SPECIES_TO_HOENN(HIJIRIBASE),
    SPECIES_TO_HOENN(HIJIRIBLUE),
    SPECIES_TO_HOENN(HIJIRIGOLD),
    SPECIES_TO_HOENN(HIJIRIPINK),
    SPECIES_TO_HOENN(RISABASE),
    SPECIES_TO_HOENN(RISABLUE),
    SPECIES_TO_HOENN(RISAGOLD),
    SPECIES_TO_HOENN(RISAPINK),
    SPECIES_TO_HOENN(SANABASE),
    SPECIES_TO_HOENN(SANABLUE),
    SPECIES_TO_HOENN(SANAGOLD),
    SPECIES_TO_HOENN(SANAPINK),
    SPECIES_TO_HOENN(HARUBASE),
    SPECIES_TO_HOENN(HARUBLUE),
    SPECIES_TO_HOENN(HARUGOLD),
    SPECIES_TO_HOENN(HARUPINK),
    SPECIES_TO_HOENN(MIREIBASE),
    SPECIES_TO_HOENN(MIREIBLUE),
    SPECIES_TO_HOENN(MIREIGOLD),
    SPECIES_TO_HOENN(MIREIPINK),
    SPECIES_TO_HOENN(ANZUBASE),
    SPECIES_TO_HOENN(ANZUBLUE),
    SPECIES_TO_HOENN(ANZUGOLD),
    SPECIES_TO_HOENN(ANZUPINK),
    SPECIES_TO_HOENN(KIRARIBASE),
    SPECIES_TO_HOENN(KIRARIBLUE),
    SPECIES_TO_HOENN(KIRARIGOLD),
    SPECIES_TO_HOENN(KIRARIPINK),
    SPECIES_TO_HOENN(NATALIABASE),
    SPECIES_TO_HOENN(NATALIABLUE),
    SPECIES_TO_HOENN(NATALIAGOLD),
    SPECIES_TO_HOENN(NATALIAPINK),
...
{
    SPECIES_TO_NATIONAL(UZUKIBASE),
    SPECIES_TO_NATIONAL(UZUKIBLUE),
    SPECIES_TO_NATIONAL(UZUKIGOLD),
    SPECIES_TO_NATIONAL(UZUKIPINK),
    SPECIES_TO_NATIONAL(RINBASE),
    SPECIES_TO_NATIONAL(RINBLUE),
    SPECIES_TO_NATIONAL(RINGOLD),
    SPECIES_TO_NATIONAL(RINPINK),
    SPECIES_TO_NATIONAL(MIOBASE),
    SPECIES_TO_NATIONAL(MIOBLUE),
    SPECIES_TO_NATIONAL(MIOGOLD),
    SPECIES_TO_NATIONAL(MIOPINK),
    SPECIES_TO_NATIONAL(MIRIABASE),
    SPECIES_TO_NATIONAL(MIRIABLUE),
    SPECIES_TO_NATIONAL(MIRIAGOLD),
    SPECIES_TO_NATIONAL(MIRIAPINK),
    SPECIES_TO_NATIONAL(KAORUBASE),
    SPECIES_TO_NATIONAL(KAORUBLUE),
    SPECIES_TO_NATIONAL(KAORUGOLD),
    SPECIES_TO_NATIONAL(KAORUPINK),
    SPECIES_TO_NATIONAL(RIINABASE),
    SPECIES_TO_NATIONAL(RIINABLUE),
    SPECIES_TO_NATIONAL(RIINAGOLD),
    SPECIES_TO_NATIONAL(RIINAPINK),
    SPECIES_TO_NATIONAL(NANAMIBASE),
    SPECIES_TO_NATIONAL(NANAMIBLUE),
    SPECIES_TO_NATIONAL(NANAMIGOLD),
    SPECIES_TO_NATIONAL(NANAMIPINK),
    SPECIES_TO_NATIONAL(ATSUMIBASE),
    SPECIES_TO_NATIONAL(ATSUMIBLUE),
    SPECIES_TO_NATIONAL(ATSUMIGOLD),
    SPECIES_TO_NATIONAL(ATSUMIPINK),
    SPECIES_TO_NATIONAL(KOZUEBASE),
    SPECIES_TO_NATIONAL(KOZUEBLUE),
    SPECIES_TO_NATIONAL(KOZUEGOLD),
    SPECIES_TO_NATIONAL(KOZUEPINK),
    SPECIES_TO_NATIONAL(NINABASE),
    SPECIES_TO_NATIONAL(NINABLUE),
    SPECIES_TO_NATIONAL(NINAGOLD),
    SPECIES_TO_NATIONAL(NINAPINK),
    SPECIES_TO_NATIONAL(SACHIKOBASE),
    SPECIES_TO_NATIONAL(SACHIKOBLUE),
    SPECIES_TO_NATIONAL(SACHIKOGOLD),
    SPECIES_TO_NATIONAL(SACHIKOPINK),
    SPECIES_TO_NATIONAL(LAYLABASE),
    SPECIES_TO_NATIONAL(LAYLABLUE),
    SPECIES_TO_NATIONAL(LAYLAGOLD),
    SPECIES_TO_NATIONAL(LAYLAPINK),
    SPECIES_TO_NATIONAL(REINABASE),
    SPECIES_TO_NATIONAL(REINABLUE),
    SPECIES_TO_NATIONAL(REINAGOLD),
    SPECIES_TO_NATIONAL(REINAPINK),
    SPECIES_TO_NATIONAL(MOMOKABASE),
    SPECIES_TO_NATIONAL(MOMOKABLUE),
    SPECIES_TO_NATIONAL(MOMOKAGOLD),
    SPECIES_TO_NATIONAL(MOMOKAPINK),
    SPECIES_TO_NATIONAL(ARISUBASE),
    SPECIES_TO_NATIONAL(ARISUBLUE),
    SPECIES_TO_NATIONAL(ARISUGOLD),
    SPECIES_TO_NATIONAL(ARISUPINK),
    SPECIES_TO_NATIONAL(AIRIBASE),
    SPECIES_TO_NATIONAL(AIRIBLUE),
    SPECIES_TO_NATIONAL(AIRIGOLD),
    SPECIES_TO_NATIONAL(AIRIPINK),
    SPECIES_TO_NATIONAL(MINAMIBASE),
    SPECIES_TO_NATIONAL(MINAMIBLUE),
    SPECIES_TO_NATIONAL(MINAMIGOLD),
    SPECIES_TO_NATIONAL(MINAMIPINK),
    SPECIES_TO_NATIONAL(ANASTASIABASE),
    SPECIES_TO_NATIONAL(ANASTASIABLUE),
    SPECIES_TO_NATIONAL(ANASTASIAGOLD),
    SPECIES_TO_NATIONAL(ANASTASIAPINK),
    SPECIES_TO_NATIONAL(HIJIRIBASE),
    SPECIES_TO_NATIONAL(HIJIRIBLUE),
    SPECIES_TO_NATIONAL(HIJIRIGOLD),
    SPECIES_TO_NATIONAL(HIJIRIPINK),
    SPECIES_TO_NATIONAL(RISABASE),
    SPECIES_TO_NATIONAL(RISABLUE),
    SPECIES_TO_NATIONAL(RISAGOLD),
    SPECIES_TO_NATIONAL(RISAPINK),
    SPECIES_TO_NATIONAL(SANABASE),
    SPECIES_TO_NATIONAL(SANABLUE),
    SPECIES_TO_NATIONAL(SANAGOLD),
    SPECIES_TO_NATIONAL(SANAPINK),
    SPECIES_TO_NATIONAL(HARUBASE),
    SPECIES_TO_NATIONAL(HARUBLUE),
    SPECIES_TO_NATIONAL(HARUGOLD),
    SPECIES_TO_NATIONAL(HARUPINK),
    SPECIES_TO_NATIONAL(MIREIBASE),
    SPECIES_TO_NATIONAL(MIREIBLUE),
    SPECIES_TO_NATIONAL(MIREIGOLD),
    SPECIES_TO_NATIONAL(MIREIPINK),
    SPECIES_TO_NATIONAL(ANZUBASE),
    SPECIES_TO_NATIONAL(ANZUBLUE),
    SPECIES_TO_NATIONAL(ANZUGOLD),
    SPECIES_TO_NATIONAL(ANZUPINK),
    SPECIES_TO_NATIONAL(KIRARIBASE),
    SPECIES_TO_NATIONAL(KIRARIBLUE),
    SPECIES_TO_NATIONAL(KIRARIGOLD),
    SPECIES_TO_NATIONAL(KIRARIPINK),
    SPECIES_TO_NATIONAL(NATALIABASE),
    SPECIES_TO_NATIONAL(NATALIABLUE),
    SPECIES_TO_NATIONAL(NATALIAGOLD),
    SPECIES_TO_NATIONAL(NATALIAPINK),
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(AIRIGOLD),
    HOENN_TO_NATIONAL(AIRIPINK),
    HOENN_TO_NATIONAL(MINAMIBASE),
    ...
    HOENN_TO_NATIONAL(HIJIRIBLUE),
    HOENN_TO_NATIONAL(HIJIRIGOLD),
    HOENN_TO_NATIONAL(HIJIRIPINK),
    HOENN_TO_NATIONAL(NOSEPASS),
    HOENN_TO_NATIONAL(SKITTY),
    HOENN_TO_NATIONAL(DELCATTY),
    HOENN_TO_NATIONAL(SACHIKOBASE),
    HOENN_TO_NATIONAL(SACHIKOBLUE),
    HOENN_TO_NATIONAL(CROBAT),
    HOENN_TO_NATIONAL(ANASTASIAPINK),
    HOENN_TO_NATIONAL(HIJIRIBASE),
    HOENN_TO_NATIONAL(SABLEYE),
    HOENN_TO_NATIONAL(MAWILE),
    HOENN_TO_NATIONAL(ARON),
    HOENN_TO_NATIONAL(LAIRON),
    HOENN_TO_NATIONAL(AGGRON),
    HOENN_TO_NATIONAL(MINAMIBLUE),
    HOENN_TO_NATIONAL(MINAMIGOLD),
    HOENN_TO_NATIONAL(MINAMIPINK),
    ...
    HOENN_TO_NATIONAL(SANABASE),
    HOENN_TO_NATIONAL(SANABLUE),
    HOENN_TO_NATIONAL(KIRARIPINK),
    HOENN_TO_NATIONAL(NATALIABASE),
    HOENN_TO_NATIONAL(VOLBEAT),
    HOENN_TO_NATIONAL(ILLUMISE),
    HOENN_TO_NATIONAL(SACHIKOGOLD),
    HOENN_TO_NATIONAL(SACHIKOPINK),
    HOENN_TO_NATIONAL(LAYLABASE),
    HOENN_TO_NATIONAL(BELLOSSOM),
    HOENN_TO_NATIONAL(SANAPINK),
    HOENN_TO_NATIONAL(HARUBASE),
    ...
    HOENN_TO_NATIONAL(HARUPINK),
    HOENN_TO_NATIONAL(MIREIBASE),
    HOENN_TO_NATIONAL(KOFFING),
    HOENN_TO_NATIONAL(WEEZING),
    HOENN_TO_NATIONAL(SPOINK),
    HOENN_TO_NATIONAL(GRUMPIG),
    HOENN_TO_NATIONAL(NANAMIGOLD),
    HOENN_TO_NATIONAL(NANAMIPINK),
    ...
    HOENN_TO_NATIONAL(NINAGOLD),
    HOENN_TO_NATIONAL(NINAPINK),
    ...
    HOENN_TO_NATIONAL(NINABASE),
    HOENN_TO_NATIONAL(NINABLUE),
    HOENN_TO_NATIONAL(PICHU),
    HOENN_TO_NATIONAL(NANAMIBASE),
    HOENN_TO_NATIONAL(NANAMIBLUE),
    HOENN_TO_NATIONAL(MOMOKABLUE),
    HOENN_TO_NATIONAL(MOMOKAGOLD),
    ...
    HOENN_TO_NATIONAL(UZUKIBASE), // Pokémon from here onwards are UNSEEN in the HoennDex.
    HOENN_TO_NATIONAL(UZUKIBLUE),
    HOENN_TO_NATIONAL(UZUKIGOLD),
    HOENN_TO_NATIONAL(UZUKIPINK),
    HOENN_TO_NATIONAL(RINBASE),
    HOENN_TO_NATIONAL(RINBLUE),
    HOENN_TO_NATIONAL(RINGOLD),
    HOENN_TO_NATIONAL(RINPINK),
    HOENN_TO_NATIONAL(MIOBASE),
    HOENN_TO_NATIONAL(MIOBLUE),
    HOENN_TO_NATIONAL(MIOGOLD),
    HOENN_TO_NATIONAL(MIOPINK),
    HOENN_TO_NATIONAL(MIRIABASE),
    HOENN_TO_NATIONAL(MIRIABLUE),
    HOENN_TO_NATIONAL(MIRIAGOLD),
    HOENN_TO_NATIONAL(MIRIAPINK),
    HOENN_TO_NATIONAL(KAORUBASE),
    HOENN_TO_NATIONAL(KAORUBLUE),
    HOENN_TO_NATIONAL(KAORUGOLD),
    HOENN_TO_NATIONAL(KAORUPINK),
    HOENN_TO_NATIONAL(RIINABASE),
    HOENN_TO_NATIONAL(RIINABLUE),
    HOENN_TO_NATIONAL(RIINAGOLD),
    HOENN_TO_NATIONAL(RIINAPINK),
    HOENN_TO_NATIONAL(ATSUMIBASE),
    HOENN_TO_NATIONAL(ATSUMIBLUE),
    HOENN_TO_NATIONAL(ATSUMIGOLD),
    HOENN_TO_NATIONAL(ATSUMIPINK),
    HOENN_TO_NATIONAL(KOZUEBASE),
    HOENN_TO_NATIONAL(KOZUEBLUE),
    HOENN_TO_NATIONAL(KOZUEGOLD),
    HOENN_TO_NATIONAL(KOZUEPINK),
    HOENN_TO_NATIONAL(LAYLABLUE),
    HOENN_TO_NATIONAL(LAYLAGOLD),
    HOENN_TO_NATIONAL(LAYLAPINK),
    HOENN_TO_NATIONAL(REINABASE),
    HOENN_TO_NATIONAL(REINABLUE),
    HOENN_TO_NATIONAL(REINAGOLD),
    HOENN_TO_NATIONAL(REINAPINK),
    HOENN_TO_NATIONAL(MOMOKABASE),
    HOENN_TO_NATIONAL(MOMOKAPINK),
    HOENN_TO_NATIONAL(ARISUBASE),
    HOENN_TO_NATIONAL(ARISUBLUE),
    HOENN_TO_NATIONAL(ARISUGOLD),
    HOENN_TO_NATIONAL(ARISUPINK),
    HOENN_TO_NATIONAL(AIRIBASE),
    HOENN_TO_NATIONAL(AIRIBLUE),
    HOENN_TO_NATIONAL(ANASTASIABASE),
    HOENN_TO_NATIONAL(ANASTASIABLUE),
    HOENN_TO_NATIONAL(ANASTASIAGOLD),
    HOENN_TO_NATIONAL(RISABASE),
    HOENN_TO_NATIONAL(RISABLUE),
    HOENN_TO_NATIONAL(RISAGOLD),
    HOENN_TO_NATIONAL(RISAPINK),
    HOENN_TO_NATIONAL(SANAGOLD),
    HOENN_TO_NATIONAL(HARUBLUE),
    HOENN_TO_NATIONAL(HARUGOLD),
    HOENN_TO_NATIONAL(MIREIBLUE),
    HOENN_TO_NATIONAL(MIREIGOLD),
    HOENN_TO_NATIONAL(MIREIPINK),
    HOENN_TO_NATIONAL(ANZUBASE),
    HOENN_TO_NATIONAL(ANZUBLUE),
    HOENN_TO_NATIONAL(ANZUGOLD),
    HOENN_TO_NATIONAL(ANZUPINK),
    HOENN_TO_NATIONAL(KIRARIBASE),
    HOENN_TO_NATIONAL(KIRARIBLUE),
    HOENN_TO_NATIONAL(KIRARIGOLD),
    HOENN_TO_NATIONAL(NATALIABLUE),
    HOENN_TO_NATIONAL(NATALIAGOLD),
    HOENN_TO_NATIONAL(NATALIAPINK),
...
{
    [SPECIES_UZUKIBASE - 1]   = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_UZUKIBLUE - 1]     = ANIM_V_STRETCH,
    [SPECIES_UZUKIGOLD - 1]    = ANIM_ROTATE_UP_SLAM_DOWN,
    [SPECIES_UZUKIPINK - 1]  = ANIM_V_JUMPS_SMALL,
    [SPECIES_RINBASE - 1]  = ANIM_BACK_AND_LUNGE,
    [SPECIES_RINBLUE - 1]   = ANIM_V_SHAKE,
    [SPECIES_RINGOLD - 1]    = ANIM_SWING_CONCAVE,
    [SPECIES_RINPINK - 1]   = ANIM_SHRINK_GROW,
    [SPECIES_MIOBASE - 1]   = ANIM_V_SHAKE_TWICE,
    [SPECIES_MIOBLUE - 1]    = ANIM_SWING_CONCAVE,
    [SPECIES_MIOGOLD - 1]     = ANIM_SWING_CONCAVE,
    [SPECIES_MIOPINK - 1]  = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_MIRIABASE - 1]      = ANIM_H_SLIDE_SLOW,
    [SPECIES_MIRIABLUE - 1]      = ANIM_GLOW_ORANGE,
    [SPECIES_MIRIAGOLD - 1]    = ANIM_H_VIBRATE,
    [SPECIES_MIRIAPINK - 1]      = ANIM_V_SLIDE_SLOW,
    [SPECIES_KAORUBASE - 1]   = ANIM_V_STRETCH,
    [SPECIES_KAORUBLUE - 1]     = ANIM_FRONT_FLIP,
    [SPECIES_KAORUGOLD - 1]     = ANIM_RAPID_H_HOPS,
    [SPECIES_KAORUPINK - 1]    = ANIM_FIGURE_8,
    [SPECIES_RIINABASE - 1]     = ANIM_RISING_WOBBLE,
    [SPECIES_RIINABLUE - 1]      = ANIM_FIGURE_8,
    [SPECIES_RIINAGOLD - 1]       = ANIM_H_STRETCH,
    [SPECIES_RIINAPINK - 1]       = ANIM_V_STRETCH,
    [SPECIES_NANAMIBASE - 1]     = ANIM_FLASH_YELLOW,
    [SPECIES_NANAMIBLUE - 1]      = ANIM_V_STRETCH,
    [SPECIES_NANAMIGOLD - 1]   = ANIM_SWING_CONCAVE_FAST_SHORT,
    [SPECIES_NANAMIPINK - 1]   = ANIM_V_STRETCH,
    [SPECIES_ATSUMIBASE - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ATSUMIBLUE - 1]    = ANIM_V_STRETCH,
    [SPECIES_ATSUMIGOLD - 1]   = ANIM_H_SHAKE,
    [SPECIES_ATSUMIPINK - 1]   = ANIM_GROW_VIBRATE,
    [SPECIES_KOZUEBASE - 1]    = ANIM_SHRINK_GROW,
    [SPECIES_KOZUEBLUE - 1]    = ANIM_H_SHAKE,
    [SPECIES_KOZUEGOLD - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KOZUEPINK - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL_SLOW,
    [SPECIES_NINABASE - 1]      = ANIM_V_STRETCH,
    [SPECIES_NINABLUE - 1]   = ANIM_V_SHAKE,
    [SPECIES_NINAGOLD - 1]  = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_NINAPINK - 1]  = ANIM_H_JUMPS,
    [SPECIES_SACHIKOBASE - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SACHIKOBLUE - 1]      = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_SACHIKOGOLD - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SACHIKOPINK - 1]       = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_LAYLABASE - 1]   = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
    [SPECIES_LAYLABLUE - 1]       = ANIM_H_SLIDE_SLOW,
    [SPECIES_LAYLAGOLD - 1]    = ANIM_H_SHAKE,
    [SPECIES_LAYLAPINK - 1]     = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_REINABASE - 1]    = ANIM_ZIGZAG_SLOW,
    [SPECIES_REINABLUE - 1]     = ANIM_V_SHAKE,
    [SPECIES_REINAGOLD - 1]     = ANIM_H_SHAKE_SLOW,
    [SPECIES_REINAPINK - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_MOMOKABASE - 1]     = ANIM_V_STRETCH,
    [SPECIES_MOMOKABLUE - 1]     = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_MOMOKAGOLD - 1]     = ANIM_H_SHAKE_SLOW,
    [SPECIES_MOMOKAPINK - 1]      = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_ARISUBASE - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_ARISUBLUE - 1]   = ANIM_BACK_AND_LUNGE,
    [SPECIES_ARISUGOLD - 1]    = ANIM_H_VIBRATE,
    [SPECIES_ARISUPINK - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AIRIBASE - 1]   = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_AIRIBLUE - 1]   = ANIM_V_SHAKE_TWICE,
    [SPECIES_AIRIGOLD - 1]        = ANIM_H_JUMPS,
    [SPECIES_AIRIPINK - 1]     = ANIM_GROW_VIBRATE,
    [SPECIES_MINAMIBASE - 1]    = ANIM_V_STRETCH,
    [SPECIES_MINAMIBLUE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MINAMIGOLD - 1]     = ANIM_V_SHAKE,
    [SPECIES_MINAMIPINK - 1]     = ANIM_H_JUMPS,
    [SPECIES_ANASTASIABASE - 1]  = ANIM_V_STRETCH,
    [SPECIES_ANASTASIABLUE - 1]  = ANIM_SWING_CONVEX,
    [SPECIES_ANASTASIAGOLD - 1]  = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_ANASTASIAPINK - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HIJIRIBASE - 1]  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HIJIRIBLUE - 1]     = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_HIJIRIGOLD - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_HIJIRIPINK - 1]       = ANIM_ROTATE_UP_SLAM_DOWN,
    [SPECIES_RISABASE - 1]      = ANIM_GLOW_ORANGE,
    [SPECIES_RISABLUE - 1]    = ANIM_CIRCULAR_VIBRATE,
    [SPECIES_RISAGOLD - 1]    = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_RISAPINK - 1]     = ANIM_SWING_CONCAVE,
    [SPECIES_SANABASE - 1]   = ANIM_TUMBLING_FRONT_FLIP_TWICE,
    [SPECIES_SANABLUE - 1]    = ANIM_FLASH_YELLOW,
    [SPECIES_SANAGOLD - 1]   = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_SANAPINK - 1]       = ANIM_H_SHAKE_SLOW,
    [SPECIES_HARUBASE - 1]      = ANIM_LUNGE_GROW,
    [SPECIES_HARUBLUE - 1]        = ANIM_SWING_CONCAVE,
    [SPECIES_HARUGOLD - 1]     = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_HARUPINK - 1]      = ANIM_H_SLIDE_SLOW,
    [SPECIES_MIREIBASE - 1]         = ANIM_DEEP_V_SQUISH_AND_BOUNCE,
    [SPECIES_MIREIBLUE - 1]    = ANIM_TWIST,
    [SPECIES_MIREIGOLD - 1]    = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_MIREIPINK - 1]      = ANIM_GLOW_BLACK,
    [SPECIES_ANZUBASE - 1]     = ANIM_FLICKER_INCREASING,
    [SPECIES_ANZUBLUE - 1]      = ANIM_GROW_IN_STAGES,
    [SPECIES_ANZUGOLD - 1]        = ANIM_RAPID_H_HOPS,
    [SPECIES_ANZUPINK - 1]     = ANIM_CIRCLE_C_CLOCKWISE_SLOW,
    [SPECIES_KIRARIBASE - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_KIRARIBLUE - 1]      = ANIM_H_SLIDE,
    [SPECIES_KIRARIGOLD - 1]     = ANIM_ZIGZAG_SLOW,
    [SPECIES_KIRARIPINK - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NATALIABASE - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NATALIABLUE - 1]   = ANIM_H_SLIDE_SLOW,
    [SPECIES_NATALIAGOLD - 1]   = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_NATALIAPINK - 1]      = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
...
{
    [SPECIES_MIOBASE - 1]  = 50,
    [SPECIES_MIRIABASE - 1]     = 10,
    [SPECIES_MIRIABLUE - 1]     = 20,
    [SPECIES_MIRIAGOLD - 1]   = 35,
    [SPECIES_KAORUBASE - 1]  = 25,
    [SPECIES_RIINABLUE - 1]     = 2,
    [SPECIES_RIINAGOLD - 1]      = 30,
    [SPECIES_ATSUMIBASE - 1]  = 28,
    [SPECIES_KOZUEBLUE - 1]   = 25,
    [SPECIES_LAYLABLUE - 1]      = 10,
    [SPECIES_LAYLAGOLD - 1]   = 45,
    [SPECIES_LAYLAPINK - 1]    = 20,
    [SPECIES_REINABLUE - 1]    = 25,
    [SPECIES_REINAGOLD - 1]    = 35,
    [SPECIES_REINAPINK - 1]     = 40,
    [SPECIES_MOMOKABASE - 1]    = 20,
    [SPECIES_MOMOKAPINK - 1]     = 20,
    [SPECIES_ARISUBLUE - 1]  = 30,
    [SPECIES_ARISUGOLD - 1]   = 40,
    [SPECIES_AIRIBASE - 1]  = 5,
    [SPECIES_ANASTASIABLUE - 1] = 3,
    [SPECIES_MIREIBASE - 1]        = 45,
    [SPECIES_MIREIBLUE - 1]   = 20,
    [SPECIES_ANZUBASE - 1]    = 23,
    [SPECIES_ANZUPINK - 1]    = 48,
    [SPECIES_KIRARIBASE - 1]      = 40,
...
static const u8 sHoldEffectToType[][2] =
{
    ...
    {HOLD_EFFECT_METAL_POWER, TYPE_METAL},
    {HOLD_EFFECT_ROCK_POWER, TYPE_ROCK},
    {HOLD_EFFECT_WILD_POWER, TYPE_WILD},
    {HOLD_EFFECT_NATURE_POWER, TYPE_NATURE},
    {HOLD_EFFECT_COSMIC_POWER, TYPE_COSMIC},
    {HOLD_EFFECT_SPORTS_POWER, TYPE_SPORTS},
    {HOLD_EFFECT_ANGEL_POWER, TYPE_ANGEL},
    {HOLD_EFFECT_OCEAN_POWER, TYPE_OCEAN},
    {HOLD_EFFECT_GAL_POWER, TYPE_GAL},
    {HOLD_EFFECT_TOXIC_POWER, TYPE_TOXIC},
    {HOLD_EFFECT_COLD_POWER, TYPE_COLD},
    {HOLD_EFFECT_DEVIL_POWER, TYPE_DEVIL},
    {HOLD_EFFECT_ESPER_POWER, TYPE_ESPER},
    {HOLD_EFFECT_HOT_POWER, TYPE_HOT},
    {HOLD_EFFECT_GHOST_POWER, TYPE_GHOST},
    {HOLD_EFFECT_NORMAL_POWER, TYPE_NORMAL},
    {HOLD_EFFECT_SWEET_POWER, TYPE_SWEET},
};
...
{
    MOVE_CUT, MOVE_SPACE_TRAVEL, MOVE_SURF, MOVE_STRENGTH, MOVE_FLASH,
...
static const struct SpeciesItem sAlteringCaveWildMonHeldItems[] =
{
    ...
    {SPECIES_MAREEP,    ITEM_DEF_ENERGY},
    {SPECIES_PINECO,    ITEM_SPDEF_ENERGY},
    {SPECIES_HOUNDOUR,  ITEM_ORAN_BERRY},
    {SPECIES_TEDDIURSA, ITEM_SPATK_ENERGY},
    {SPECIES_AIPOM,     ITEM_RAWST_BERRY},
    {SPECIES_SHUCKLE,   ITEM_CHERI_BERRY},
    {SPECIES_STANTLER,  ITEM_SPATK_ENERGY},
    {SPECIES_SMEARGLE,  ITEM_SPEED_ENERGY},
};
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (defenderHoldEffect == HOLD_EFFECT_DEEP_SEA_SCALE && defender->species == SPECIES_CLAMPERL)
        spDefense *= 2;
    if (attackerHoldEffect == HOLD_EFFECT_LIGHT_BALL && attacker->species == SPECIES_NANAMIBASE)
        spAttack *= 2;
    if (defenderHoldEffect == HOLD_EFFECT_METAL_POWDER && defender->species == SPECIES_DITTO)
        defense *= 2;
    if (attackerHoldEffect == HOLD_EFFECT_THICK_CLUB && (attacker->species == SPECIES_NATALIAPINK || attacker->species == SPECIES_MAROWAK))
        attack *= 2;
    ...
    if (IS_TYPE_SPECIAL(type))
    {
        ...
        if (gBattleMoves[move].flags & FLAG_PHYSICAL)
        {
          if (gCritMultiplier >= 2)
          {
              // Critical hit, if attacker has lost attack stat stages then ignore stat drop
...
bool32 IsHMMove2(u16 move)
{
    ...
    {
        if (sHMMoves[i++] == move)
            return FALSE; //hot fix to allow removing hm moves
    }
    return FALSE;
}
