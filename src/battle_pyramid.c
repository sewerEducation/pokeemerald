...
{
    {ITEM_HYPER_POTION, ITEM_POKE_DOLL, ITEM_CHERI_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_RANDO_ENERGY, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_CRIT_ENERGY, ITEM_PECHA_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_RANDO_ENERGY, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_ORAN_BERRY},
    {ITEM_HYPER_POTION, ITEM_ATK_ENERGY, ITEM_RAWST_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_RANDO_ENERGY, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_DEF_ENERGY, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_RANDO_ENERGY, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_ORAN_BERRY},
    {ITEM_HYPER_POTION, ITEM_SPEED_ENERGY, ITEM_CHESTO_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_RANDO_ENERGY, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_RANDO_ENERGY, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_RANDO_ENERGY, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_ORAN_BERRY},
    {ITEM_HYPER_POTION, ITEM_SPATK_ENERGY, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_RANDO_ENERGY, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_SPDEF_ENERGY, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_RANDO_ENERGY, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_ORAN_BERRY},
    {ITEM_HYPER_POTION, ITEM_POKE_DOLL, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_RANDO_ENERGY, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_CRIT_ENERGY, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_RANDO_ENERGY, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_ORAN_BERRY},
    {ITEM_HYPER_POTION, ITEM_ATK_ENERGY, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_RANDO_ENERGY, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_DEF_ENERGY, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_RANDO_ENERGY, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_ORAN_BERRY},
    {ITEM_HYPER_POTION, ITEM_SPEED_ENERGY, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_RANDO_ENERGY, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_RANDO_ENERGY, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_RANDO_ENERGY, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_ORAN_BERRY},
    {ITEM_HYPER_POTION, ITEM_SPATK_ENERGY, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_RANDO_ENERGY, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_SPDEF_ENERGY, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_RANDO_ENERGY, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_ORAN_BERRY},
    {ITEM_HYPER_POTION, ITEM_POKE_DOLL, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_RANDO_ENERGY, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
...
static void InitPyramidBagItems(u8 lvlMode)
{
    ...
    AddPyramidBagItem(ITEM_LEPPA_BERRY, 1);
}
