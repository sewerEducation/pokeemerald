        ...
        {
            {
                ...
                .moves = {MOVE_HEAVEN_PUNCH, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH, MOVE_DISABLE},
            },
            {
        ...
        {
            {
                ...
                .moves = {MOVE_HEAVENBOLT, MOVE_CALM_MIND, MOVE_REFLECT, MOVE_REST},
            },
            {
                ...
                .nature = NATURE_MODEST,
                .evs = {252, 0, 252, 6, 0, 0},
                .moves = {MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_RECOVER, MOVE_DEVIL_CLAW},
            },
            {
                .species = SPECIES_SNORLAX,
    ...
    [FRONTIER_FACILITY_DOME] =
    {
        // Silver Symbol.
        {
            ...
            },
            {
                ...
                .moves = {MOVE_EARTHQUAKE, MOVE_BRICK_BREAK, MOVE_DEVIL_CLAW, MOVE_AERIAL_ACE},
            },
            {
        ...
        // Gold Symbol.
        {
            ...
            },
            {
                ...
                .nature = NATURE_MODEST,
                .evs = {252, 0, 252, 6, 0, 0},
                .moves = {MOVE_HEAVENBOLT, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_REST},
            },
        },
    },
    ...
    [FRONTIER_FACILITY_ARENA] =
    {
        ...
        {
            {
                ...
                .moves = {MOVE_BEETLEHORN, MOVE_ROCK_TOMB, MOVE_ENDURE, MOVE_REVERSAL},
            },
            {
        ...
        // Gold Symbol.
        {
            ...
            },
            {
                ...
                .nature = NATURE_JOLLY,
                .evs = {6, 252, 0, 252, 0, 0},
                .moves = {MOVE_SPORE, MOVE_FOCUS_BLAST, MOVE_GIGA_DRAIN, MOVE_HEADBUTT},
            },
        },
    },
    [FRONTIER_FACILITY_FACTORY] =
    {
        ...
        // What is interesting, this team is actually the one Steven uses in the multi tag battle alongside the player.
        {
            ...
            },
            {
                ...
                .evs = {252, 0, 0, 0, 6, 252},
                .moves = {MOVE_TOXIC, MOVE_AERIAL_ACE, MOVE_PROTECT, MOVE_METAL_GALE},
            },
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {0, 252, 0, 0, 252, 6},
                .moves = {MOVE_HEAVENBOLT, MOVE_PROTECT, MOVE_SOLAR_BEAM, MOVE_DEVIL_CLAW},
            },
        },
        {
            {
    ...
    [FRONTIER_FACILITY_PIKE] =
    {
        ...
        // Gold Symbol.
        {
            ...
            },
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {252, 6, 0, 0, 0, 252},
                .moves = {MOVE_DEVIL_WALTZ, MOVE_RETURN, MOVE_ROAR, MOVE_REST},
            },
        },
    },
...
static void GiveBattlePoints(void)
{
    ...
    points = sBattlePointAwards[challengeNum][facility][battleMode]*2;
    if (gTrainerBattleOpponent_A == TRAINER_FRONTIER_BRAIN)
        points += 10;
