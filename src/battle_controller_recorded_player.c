...
static void (*const sRecordedPlayerBufferCommands[CONTROLLER_CMDS_COUNT])(void) =
{
    ...
    [CONTROLLER_DRAWPRODUCERPIC]           = RecordedPlayerHandleDrawTrainerPic,
    [CONTROLLER_PRODUCERSLIDE]             = RecordedPlayerHandleTrainerSlide,
    [CONTROLLER_PRODUCERSLIDEBACK]         = RecordedPlayerHandleTrainerSlideBack,
    ...
    [CONTROLLER_INTROPRODUCERBALLTHROW]    = RecordedPlayerHandleIntroTrainerBallThrow,
