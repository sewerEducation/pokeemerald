...
const u8 gEasyChatWord_Trainer[] = _("PRODUCER");
const u8 gEasyChatWord_Version[] = _("VERSION");
const u8 gEasyChatWord_Pokenav[] = _("IDOLNAV");
const u8 gEasyChatWord_Pokemon[] = _("IDOL");
const u8 gEasyChatWord_Get[] = _("GET");
const u8 gEasyChatWord_Pokedex[] = _("IDOLDEX");
