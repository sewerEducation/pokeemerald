...
const struct SpriteFrameImage *const gBerryTreePicTablePointers[] = {
    ...
    [ITEM_SPICE_APPLE - FIRST_BERRY_INDEX]   = sPicTable_FigyBerryTree,
    [ITEM_DRY_APPLE - FIRST_BERRY_INDEX]   = sPicTable_WikiBerryTree,
    [ITEM_SWEET_APPLE - FIRST_BERRY_INDEX]   = sPicTable_MagoBerryTree,
    [ITEM_BITTER_APPLE - FIRST_BERRY_INDEX]  = sPicTable_AguavBerryTree,
    [ITEM_SOUR_APPLE - FIRST_BERRY_INDEX] = sPicTable_IapapaBerryTree,
    ...
    [ITEM_ATK_ENERGY - FIRST_BERRY_INDEX] = sPicTable_LiechiBerryTree,
    [ITEM_DEF_ENERGY - FIRST_BERRY_INDEX] = sPicTable_HondewBerryTree,
    [ITEM_SPEED_ENERGY - FIRST_BERRY_INDEX]  = sPicTable_AguavBerryTree,
    [ITEM_SPATK_ENERGY - FIRST_BERRY_INDEX] = sPicTable_PomegBerryTree,
    [ITEM_SPDEF_ENERGY - FIRST_BERRY_INDEX] = sPicTable_GrepaBerryTree,
    [ITEM_CRIT_ENERGY - FIRST_BERRY_INDEX] = sPicTable_LansatBerryTree,
    [ITEM_RANDO_ENERGY - FIRST_BERRY_INDEX]  = sPicTable_CornnBerryTree,
...
const u8 *const gBerryTreePaletteSlotTablePointers[] = {
    ...
    [ITEM_SPICE_APPLE - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Figy,
    [ITEM_DRY_APPLE - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Wiki,
    [ITEM_SWEET_APPLE - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Mago,
    [ITEM_BITTER_APPLE - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Aguav,
    [ITEM_SOUR_APPLE - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Iapapa,
    ...
    [ITEM_ATK_ENERGY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Liechi,
    [ITEM_DEF_ENERGY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Hondew,
    [ITEM_SPEED_ENERGY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Aguav,
    [ITEM_SPATK_ENERGY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Pomeg,
    [ITEM_SPDEF_ENERGY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Grepa,
    [ITEM_CRIT_ENERGY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Lansat,
    [ITEM_RANDO_ENERGY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Cornn,
...
const u8 *const gBerryTreeObjectEventGraphicsIdTablePointers[] = {
    ...
    [ITEM_SPICE_APPLE - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_DRY_APPLE - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_SWEET_APPLE - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_BITTER_APPLE - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_SOUR_APPLE - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    ...
    [ITEM_ATK_ENERGY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_DEF_ENERGY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_SPEED_ENERGY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_SPATK_ENERGY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_SPDEF_ENERGY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_CRIT_ENERGY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_RANDO_ENERGY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
