...
#define PRODUCER_DIRS(a, b)  (((a-1)<<4)|(b-1))
#define PRODUCER_RANGE(a, b) ((a<<4)|(b))
...
static const struct TrainerHillChallenge sChallenge_JPDefault = {
    .numTrainers = NUM_PRODUCER_HILL_PRODUCERS_JP,
    .unused1 = 1,
    .numFloors = NUM_PRODUCER_HILL_FLOORS_JP,
    .checksum = 0x0
};
    ...
    [0] = {
        ...
        .trainers = {
            [0] = {
                ...
                .unused = TRUE,
                .speechBefore = { EC_WORD_PRODUCER, EC_WORD_MRS, EC_WORD_EXCL, EC_WORD_THEY_WERE, EC_WORD_OPPONENT, EC_WORD_CAN },
                .speechWin = { EC_WORD_PRODUCER, EC_WORD_MRS, EC_WORD_WEAK, EC_WORD_OF, EC_WORD_WERE, EC_WORD_ELLIPSIS_ELLIPSIS_ELLIPSIS },
                .speechLose = { EC_WORD_PRODUCER, EC_WORD_MRS, EC_WORD_STRONG, EC_WORD_HEY_QUES, EC_WORD_EXCL, EC_WORD_EXCL },
                .speechAfter = { EC_WORD_FABULOUS, EC_WORD_CAN_T, EC_WORD_PRODUCER, EC_WORD_MRS, EC_WORD_ELLIPSIS_ELLIPSIS_ELLIPSIS, EC_WORD_EXCITING },
                .mons = {
                    [0] = {
        ...
        .map = {
            ...
            .trainerDirections = PRODUCER_DIRS(DIR_SOUTH, DIR_NORTH),
            .trainerRanges = PRODUCER_RANGE(2, 3)
        }
    },
    [1] = {
        .trainerNum1 = 0,
        ...
        .map = {
            ...
            .trainerDirections = PRODUCER_DIRS(DIR_SOUTH, DIR_NORTH),
            .trainerRanges = PRODUCER_RANGE(3, 3)
        }
    },
};
...
{
    .numTrainers = NUM_PRODUCER_HILL_PRODUCERS,
    .unused1 = 2,
...
static const struct TrainerHillFloor sFloors_Normal[] =
{
    [0] =
    {
        ...
        .map = {
            ...
            .trainerDirections = PRODUCER_DIRS(DIR_WEST, DIR_NORTH),
            .trainerRanges = PRODUCER_RANGE(2, 1),
        }
    },
    [1] =
    {
        ...
        .map = {
            ...
            .trainerDirections = PRODUCER_DIRS(DIR_SOUTH, DIR_EAST),
            .trainerRanges = PRODUCER_RANGE(3, 5),
        }
    },
    [2] =
    {
        ...
        .map = {
            ...
            .trainerDirections = PRODUCER_DIRS(DIR_WEST, DIR_EAST),
            .trainerRanges = PRODUCER_RANGE(3, 3),
        }
    },
    [3] =
    ...
    [1] =
        {
            ...
            .map = {
                ...
                .trainerDirections = PRODUCER_DIRS(DIR_WEST, DIR_EAST),
                .trainerRanges = PRODUCER_RANGE(7, 7),
            }
        },
    [2] =
        {
            ...
            .map = {
                ...
                .trainerDirections = PRODUCER_DIRS(DIR_WEST, DIR_EAST),
                .trainerRanges = PRODUCER_RANGE(4, 4),
            }
        },
    [3] =
        {
    ...
    [0] =
        {
            ...
            .map = {
                ...
                .trainerDirections = PRODUCER_DIRS(DIR_WEST, DIR_EAST),
                .trainerRanges = PRODUCER_RANGE(2, 2),
            }
        },
    [1] =
        {
    ...
    [2] =
        {
            ...
            .map = {
                ...
                .trainerDirections = PRODUCER_DIRS(DIR_WEST, DIR_EAST),
                .trainerRanges = PRODUCER_RANGE(1, 1),
            }
        },
    [3] =
        {
    ...
    [0] =
        {
                    ...
                    [1] =
                        {
                            ...
                            .speechBefore = {EC_WORD_WE, EC_WORD_WILL_BE_HERE, EC_WORD_FOR, EC_WORD_ANY, EC_WORD_PRODUCER, EC_WORD_CHALLENGE},
                            ...
                            .speechAfter = {EC_WORD_THERE, EC_WORD_SHOULD, EC_WORD_BE, EC_WORD_A, EC_WORD_PRODUCER, EC_WORD_SCHOOL},
                            .mons =
                                {
                                    [0] =
                                        {
            ...
            .map = {
                ...
                .trainerDirections = PRODUCER_DIRS(DIR_WEST, DIR_EAST),
                .trainerRanges = PRODUCER_RANGE(5, 5),
            }
        },
    [1] =
        {
