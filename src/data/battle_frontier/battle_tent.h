...
const u16 gSlateportBattleTentTrainerMons_Davon[] =
{
    ...
    SLATEPORT_TENT_MON_NUMEL_1,
    SLATEPORT_TENT_MON_BARBOACH,
    SLATEPORT_TENT_MON_ANASTASIAPINK,
...
const u16 gSlateportBattleTentTrainerMons_Glenda[] =
{
    ...
    SLATEPORT_TENT_MON_KIRARIPINK,
    SLATEPORT_TENT_MON_SANABASE,
    SLATEPORT_TENT_MON_SOLROCK,
    SLATEPORT_TENT_MON_AIRIPINK,
...
const u16 gSlateportBattleTentTrainerMons_Davion[] =
{
    ...
    SLATEPORT_TENT_MON_KECLEON_2,
    SLATEPORT_TENT_MON_TRAPINCH_2,
    SLATEPORT_TENT_MON_NANAMIGOLD,
    SLATEPORT_TENT_MON_MINAMIGOLD,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Colten[] =
{
    ...
    SLATEPORT_TENT_MON_ELECTRIKE_1,
    SLATEPORT_TENT_MON_TAILLOW,
    SLATEPORT_TENT_MON_SACHIKOBLUE_1,
    SLATEPORT_TENT_MON_MAKUHITA,
    SLATEPORT_TENT_MON_ANASTASIAPINK,
    SLATEPORT_TENT_MON_KECLEON_1,
    SLATEPORT_TENT_MON_KECLEON_2,
...
const u16 gSlateportBattleTentTrainerMons_Kyler[] =
{
    ...
    SLATEPORT_TENT_MON_WHISMUR,
    SLATEPORT_TENT_MON_VIGOROTH,
    SLATEPORT_TENT_MON_SACHIKOBLUE_2,
    SLATEPORT_TENT_MON_PLUSLE_1,
    SLATEPORT_TENT_MON_PLUSLE_2,
...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    ...
    [SLATEPORT_TENT_TRAINER_MAGGIE] = {
        ...
        .speechBefore = {EC_POKEMON(NINABASE), EC_POKEMON(XATU), EC_POKEMON_NATIONAL(UMBREON), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_WORD_ELLIPSIS},
...
const struct FacilityMon gSlateportBattleTentMons[NUM_SLATEPORT_TENT_MONS] =
{
    ...
    [SLATEPORT_TENT_MON_ZIGZAGOON_2] = {
        .species = SPECIES_ZIGZAGOON,
        .moves = {MOVE_DIG, MOVE_MUD_SPORT, MOVE_TAIL_WAG, MOVE_REST},
    ...
    [SLATEPORT_TENT_MON_MARILL_1] = {
        ...
        .moves = {MOVE_ROLLOUT, MOVE_DEFENSE_CURL, MOVE_TAIL_WAG, MOVE_BUBBLE_BEAM},
    ...
    [SLATEPORT_TENT_MON_WINGULL_1] = {
        ...
        .moves = {MOVE_SUPERSONIC, MOVE_GROWL, MOVE_WING_ATTACK, MOVE_METAL_GALE},
    ...
    [SLATEPORT_TENT_MON_PELIPPER_1] = {
        ...
        .itemTableId = BATTLE_FRONTIER_ITEM_DEVIL_TOOTH,
    ...
    [SLATEPORT_TENT_MON_LINOONE] = {
        ...
        .moves = {MOVE_HEADBUTT, MOVE_TICKLE, MOVE_TAIL_WAG, MOVE_REST},
    ...
    [SLATEPORT_TENT_MON_GOLDEEN] = {
        ...
        .moves = {MOVE_WATER_SPORT, MOVE_NAIL_JAB, MOVE_WATERFALL, MOVE_SUPERSONIC},
    ...
    [SLATEPORT_TENT_MON_ELECTRIKE_1] = {
        ...
        .moves = {MOVE_BITE, MOVE_SWEET_TALK, MOVE_ROAR, MOVE_FLASH},
    ...
    [SLATEPORT_TENT_MON_KIRARIPINK] = {
        ...
        .moves = {MOVE_SWEET_TALK, MOVE_ROLLOUT, MOVE_CHARGE, MOVE_SCREECH},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_ARON_2] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_MUD_SLAP, MOVE_IRON_TACKLE, MOVE_HARDEN, MOVE_ROAR},
    ...
    [SLATEPORT_TENT_MON_SWELLOW] = {
        ...
        .moves = {MOVE_SUPERSONIC, MOVE_GROWL, MOVE_FOCUS_ENERGY, MOVE_POKE},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_IMPISH
    },
    ...
    [SLATEPORT_TENT_MON_LOUDRED] = {
        ...
        .moves = {MOVE_ASTONISH, MOVE_SCREECH, MOVE_ROCK_OUT, MOVE_SUPERSONIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [SLATEPORT_TENT_MON_SPINDA] = {
        ...
        .moves = {MOVE_DIZZY_HEART, MOVE_FEINT_ATTACK, MOVE_HYPNOSIS, MOVE_REST},
    ...
    [SLATEPORT_TENT_MON_SANABASE] = {
        ...
        .moves = {MOVE_METAL_SOUND, MOVE_SUPERSONIC, MOVE_ROCK_SHOCK, MOVE_SWEET_TALK},
    ...
    [SLATEPORT_TENT_MON_VIGOROTH] = {
        ...
        .itemTableId = BATTLE_FRONTIER_ITEM_BITTER_APPLE,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [SLATEPORT_TENT_MON_MAGIKARP] = {
    ...
    [SLATEPORT_TENT_MON_KECLEON_1] = {
        ...
        .moves = {MOVE_PSYBEAM, MOVE_SUBSTITUTE, MOVE_THIEF, MOVE_TAIL_WAG},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [SLATEPORT_TENT_MON_KECLEON_2] = {
        ...
        .itemTableId = BATTLE_FRONTIER_ITEM_SOUR_APPLE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CALM
    },
    [SLATEPORT_TENT_MON_SHROOMISH_1] = {
    ...
    [SLATEPORT_TENT_MON_SHROOMISH_2] = {
        ...
        .itemTableId = BATTLE_FRONTIER_ITEM_SPICE_APPLE,
    ...
    [SLATEPORT_TENT_MON_PELIPPER_2] = {
        ...
        .itemTableId = BATTLE_FRONTIER_ITEM_DRY_APPLE,
    ...
    [SLATEPORT_TENT_MON_MARILL_2] = {
        .species = SPECIES_MARILL,
        .moves = {MOVE_DOUBLE_EDGE, MOVE_RAIN_DANCE, MOVE_TAIL_WAG, MOVE_WATER_GUN},
        .itemTableId = BATTLE_FRONTIER_ITEM_DEF_ENERGY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [SLATEPORT_TENT_MON_SKITTY] = {
    ...
    [SLATEPORT_TENT_MON_RALTS] = {
        ...
        .itemTableId = BATTLE_FRONTIER_ITEM_SWEET_APPLE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_TIMID
    },
    [SLATEPORT_TENT_MON_NANAMIGOLD] = {
    ...
    [SLATEPORT_TENT_MON_PLUSLE_1] = {
        ...
        .moves = {MOVE_SWEET_TALK, MOVE_ENCORE, MOVE_ROCK_SHOCK, MOVE_GROWL},
    ...
    [SLATEPORT_TENT_MON_PLUSLE_2] = {
        .species = SPECIES_PLUSLE,
        .moves = {MOVE_SWEET_TALK, MOVE_FAKE_TEARS, MOVE_SUBSTITUTE, MOVE_QUICK_ATTACK},
    ...
    [SLATEPORT_TENT_MON_ELECTRIKE_2] = {
        .species = SPECIES_ELECTRIKE,
        .moves = {MOVE_SWEET_TALK, MOVE_CHARGE, MOVE_ROAR, MOVE_ROCK_SHOCK},
        .itemTableId = BATTLE_FRONTIER_ITEM_SPDEF_ENERGY,
        .evSpread = F_EV_SPREAD_SPEED,
        .nature = NATURE_TIMID
    },
    [SLATEPORT_TENT_MON_SWABLU] = {
        .species = SPECIES_SWABLU,
        .moves = {MOVE_SING, MOVE_POKE, MOVE_METAL_GALE, MOVE_SAFEGUARD},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_JOLLY
    },
    [SLATEPORT_TENT_MON_MINAMIBLUE] = {
        ...
        .moves = {MOVE_FOCUS_ENERGY, MOVE_BODY_PRESS, MOVE_SEISMIC_TOSS, MOVE_FORESIGHT},
...
{
    VERDANTURF_TENT_MON_HIJIRIGOLD,
    VERDANTURF_TENT_MON_TRAPINCH,
    VERDANTURF_TENT_MON_BALTOY,
    VERDANTURF_TENT_MON_SOLROCK,
    VERDANTURF_TENT_MON_MINAMIGOLD,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Markus[] =
{
    ...
    VERDANTURF_TENT_MON_ANASTASIAPINK,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Ronald[] =
{
    ...
    VERDANTURF_TENT_MON_ELECTRIKE,
    VERDANTURF_TENT_MON_KIRARIPINK,
    -1
};
...
{
    VERDANTURF_TENT_MON_MINAMIBLUE,
...
const struct BattleFrontierTrainer gVerdanturfBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    ...
    [VERDANTURF_TENT_TRAINER_MARQUIS] = {
        ...
        .speechLose = {EC_WORD_SHOULD, EC_WORD_I, EC_WORD_CAUSE, EC_WORD_AN, EC_MOVE(ACID), EC_WORD_QUES},
...
const struct FacilityMon gVerdanturfBattleTentMons[NUM_VERDANTURF_TENT_MONS] =
{
    ...
    [VERDANTURF_TENT_MON_BARBOACH] = {
        .species = SPECIES_BARBOACH,
        .moves = {MOVE_MUD_SLAP, MOVE_WATER_GUN, MOVE_RAIN_DANCE, MOVE_SWEET_TALK},
        .itemTableId = BATTLE_FRONTIER_ITEM_ASPEAR_BERRY,
        .evSpread = F_EV_SPREAD_SPEED,
        .nature = NATURE_HASTY
    },
    ...
    [VERDANTURF_TENT_MON_MAKUHITA] = {
        .species = SPECIES_MAKUHITA,
        .moves = {MOVE_BULK_UP, MOVE_ARM_THRUST, MOVE_SURPRISE_HIT, MOVE_SAND_ATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_SPEED_ENERGY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAUGHTY
    },
    [VERDANTURF_TENT_MON_SWABLU] = {
        .species = SPECIES_SWABLU,
        .moves = {MOVE_REFRESH, MOVE_SAFEGUARD, MOVE_ATTRACT, MOVE_COPYCAT},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MILD
    },
    ...
    [VERDANTURF_TENT_MON_SKARMORY] = {
        ...
        .moves = {MOVE_SOAK, MOVE_SANDSTORM, MOVE_LEER, MOVE_AGILITY},
    ...
    [VERDANTURF_TENT_MON_GOLDEEN_2] = {
        .species = SPECIES_GOLDEEN,
        .moves = {MOVE_POKE, MOVE_SUPERSONIC, MOVE_PSYBEAM, MOVE_RAIN_DANCE},
    ...
    [VERDANTURF_TENT_MON_ELECTRIKE] = {
        .species = SPECIES_ELECTRIKE,
        .moves = {MOVE_COSMIC_PULSE, MOVE_TACKLE, MOVE_CHARGE, MOVE_ROCK_SHOCK},
        .itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_MILD
    },
    ...
    [VERDANTURF_TENT_MON_KIRARIPINK] = {
        .species = SPECIES_KIRARIPINK,
        .moves = {MOVE_PROTECT, MOVE_SELF_DESTRUCT, MOVE_SWEET_TALK, MOVE_SCREECH},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_BASHFUL
    },
    [VERDANTURF_TENT_MON_SANABASE] = {
        .species = SPECIES_SANABASE,
        .moves = {MOVE_METAL_SOUND, MOVE_SUPERSONIC, MOVE_ROCK_SHOCK, MOVE_COSMIC_PULSE},
        .itemTableId = BATTLE_FRONTIER_ITEM_MAGNET,
    ...
    [VERDANTURF_TENT_MON_LOUDRED] = {
        .species = SPECIES_LOUDRED,
        .moves = {MOVE_HOWL, MOVE_ROCK_OUT, MOVE_REST, MOVE_SCREECH},
        .itemTableId = BATTLE_FRONTIER_ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CALM
    },
...
const u16 gFallarborBattleTentTrainerMons_Javier[] =
{
    ...
    FALLARBOR_TENT_MON_HIJIRIGOLD,
    FALLARBOR_TENT_MON_NANAMIGOLD,
    FALLARBOR_TENT_MON_CACNEA,
    -1
};
...
const u16 gFallarborBattleTentTrainerMons_Arianna[] =
{
    ...
    FALLARBOR_TENT_MON_SACHIKOBLUE,
    FALLARBOR_TENT_MON_CACNEA,
    -1
};
...
{
    FALLARBOR_TENT_MON_ELECTRIKE,
    FALLARBOR_TENT_MON_SANABASE,
    FALLARBOR_TENT_MON_KIRARIPINK,
    FALLARBOR_TENT_MON_WHISMUR,
    FALLARBOR_TENT_MON_LOUDRED,
    -1
};
...
const struct BattleFrontierTrainer gFallarborBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    ...
    [FALLARBOR_TENT_TRAINER_JONN] = {
        .facilityClass = FACILITY_CLASS_POKEMANIAC,
        .trainerName = _("JONN"),
        .speechBefore = {EC_WORD_THE, EC_WORD_WORLD, EC_MOVE2(ACID), EC_MOVE2(STOMP), EC_WORD_CONTEST, EC_WORD_EXCL_EXCL},
    ...
    [FALLARBOR_TENT_TRAINER_RORY] = {
        .facilityClass = FACILITY_CLASS_NINJA_BOY,
        .trainerName = _("RORY"),
        .speechBefore = {EC_WORD_DON_T, EC_WORD_CAUSE, EC_WORD_AN, EC_MOVE(ACID), EC_WORD_YOU, EC_WORD_EXCL},
        .speechWin = {EC_WORD_I, EC_WORD_DON_T, EC_WORD_NEED, EC_WORD_AN, EC_MOVE(ACID), EC_WORD_EXCL},
        .speechLose = {EC_WORD_I_AM, EC_WORD_GOING, EC_WORD_TO, EC_WORD_CAUSE, EC_WORD_AN, EC_MOVE(ACID)},
...
const struct FacilityMon gFallarborBattleTentMons[NUM_FALLARBOR_TENT_MONS] =
{
    ...
    [FALLARBOR_TENT_MON_PLUSLE] = {
        .species = SPECIES_PLUSLE,
        .moves = {MOVE_SWEET_TALK, MOVE_GROWL, MOVE_QUICK_ATTACK, MOVE_FAKE_TEARS},
        .itemTableId = BATTLE_FRONTIER_ITEM_MENTAL_HERB,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    ...
    [FALLARBOR_TENT_MON_MAKUHITA] = {
        .species = SPECIES_MAKUHITA,
        .moves = {MOVE_DETECT, MOVE_ARM_THRUST, MOVE_FAKE_OUT, MOVE_SURPRISE_HIT},
        .itemTableId = BATTLE_FRONTIER_ITEM_BLACK_BELT,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FALLARBOR_TENT_MON_ELECTRIKE] = {
        .species = SPECIES_ELECTRIKE,
        .moves = {MOVE_VAMPIRE, MOVE_ROCK_SHOCK, MOVE_HOWL, MOVE_QUICK_ATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_SEA_INCENSE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HASTY
    },
    [FALLARBOR_TENT_MON_SANABASE] = {
        .species = SPECIES_SANABASE,
        .moves = {MOVE_ROCK_SHOCK, MOVE_SUPERSONIC, MOVE_ENDURE, MOVE_SWEET_TALK},
        .itemTableId = BATTLE_FRONTIER_ITEM_MAGNET,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [FALLARBOR_TENT_MON_KIRARIPINK] = {
        .species = SPECIES_KIRARIPINK,
        .moves = {MOVE_CHARGE, MOVE_SWEET_TALK, MOVE_SCREECH, MOVE_SONIC_BOOM},
        .itemTableId = BATTLE_FRONTIER_ITEM_ASPEAR_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    ...
    [FALLARBOR_TENT_MON_LOUDRED] = {
        .species = SPECIES_LOUDRED,
        .moves = {MOVE_STOMP, MOVE_REST, MOVE_SCREECH, MOVE_ROCK_OUT},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FALLARBOR_TENT_MON_SKARMORY] = {
        .species = SPECIES_SKARMORY,
        .moves = {MOVE_AGILITY, MOVE_METAL_GALE, MOVE_SAND_ATTACK, MOVE_TORMENT},
        .itemTableId = BATTLE_FRONTIER_ITEM_METAL_COAT,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    ...
    [FALLARBOR_TENT_MON_BARBOACH] = {
        .species = SPECIES_BARBOACH,
        .moves = {MOVE_SWEET_TALK, MOVE_WATER_GUN, MOVE_EARTHQUAKE, MOVE_WATER_SPORT},
        .itemTableId = BATTLE_FRONTIER_ITEM_ATK_ENERGY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    ...
    [FALLARBOR_TENT_MON_GOLDEEN_2] = {
        .species = SPECIES_GOLDEEN,
        .moves = {MOVE_SLEEP_TALK, MOVE_HEAD_SMASH, MOVE_REST, MOVE_SUPERSONIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_MENTAL_HERB,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CAREFUL
    },
    ...
    [FALLARBOR_TENT_MON_BALTOY] = {
        .species = SPECIES_BALTOY,
        .moves = {MOVE_SELF_DESTRUCT, MOVE_SANDSTORM, MOVE_TIDY_UP, MOVE_MIMIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
    ...
    [FALLARBOR_TENT_MON_NANAMIGOLD] = {
        .species = SPECIES_NANAMIGOLD,
        .moves = {MOVE_SAND_TOMB, MOVE_SANDSTORM, MOVE_DOUBLE_TEAM, MOVE_FOCUS_BLAST},
        .itemTableId = BATTLE_FRONTIER_ITEM_WILD_CLUB,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_JOLLY
    },
