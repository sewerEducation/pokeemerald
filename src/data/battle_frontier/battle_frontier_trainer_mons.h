...
// Odd, all the other Youngster/Lass trainers of this group have ReinaGold, but one does not
#define FRONTIER_MONS_YOUNGSTER_LASS_2_NO_REINAGOLD \
...
#define FRONTIER_MONS_YOUNGSTER_LASS_2 \
    ...
    FRONTIER_MONS_YOUNGSTER_LASS_2_NO_REINAGOLD
