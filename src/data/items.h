...
// Berries
    ...
    [ITEM_BITTER_APPLE] =
    {
        .name = _("BITTER APPPLE"),
        .itemId = ITEM_BITTER_APPLE,
        .price = 700,
...
// Hold items
    ...
    [ITEM_METAL_COAT] =
    {
        ...
        .price = 100,
        .holdEffect = HOLD_EFFECT_METAL_POWER,
        .holdEffectParam = 10,
    ...
    [ITEM_LIGHT_BALL] =
    {
        ...
        .price = 100,
        .holdEffect = HOLD_EFFECT_ANGEL_POWER,
        .holdEffectParam = 30,
    ...
    {
        .name = _("WILD CLUB"),
        .itemId = ITEM_WILD_CLUB,
        .price = 100,
        .holdEffect = HOLD_EFFECT_WILD_POWER,
        .holdEffectParam = 30,
    ...
    [ITEM_BLACK_BELT] =
    {
        ...
        .price = 100,
        .holdEffect = HOLD_EFFECT_SPORTS_POWER,
        .holdEffectParam = 30,
    ...
    [ITEM_MYSTIC_WATER] =
    {
        ...
        .price = 100,
        .holdEffect = HOLD_EFFECT_OCEAN_POWER,
        .holdEffectParam = 30,
    ...
    {
        .name = _("ACRYLIC NAIL"),
        .itemId = ITEM_ACRYLIC_NAIL,
        .price = 100,
        .holdEffect = HOLD_EFFECT_GAL_POWER,
        .holdEffectParam = 30,
    ...
    [ITEM_POISON_BARB] =
    {
        ...
        .price = 100,
        .holdEffect = HOLD_EFFECT_TOXIC_POWER,
        .holdEffectParam = 30,
    ...
    [ITEM_NEVER_MELT_ICE] =
    {
        ...
        .price = 100,
        .holdEffect = HOLD_EFFECT_COLD_POWER,
        .holdEffectParam = 30,
    ...
    [ITEM_TWISTED_SPOON] =
    {
        ...
        .price = 100,
        .holdEffect = HOLD_EFFECT_ESPER_POWER,
        .holdEffectParam = 30,
    ...
    [ITEM_CHARCOAL] =
    {
        ...
        .price = 9800,
        .holdEffect = HOLD_EFFECT_HOT_POWER,
        .holdEffectParam = 30,
    ...
    {
        .name = _("DEVIL TOOTH"),
        .itemId = ITEM_DEVIL_TOOTH,
        .price = 100,
        .holdEffect = HOLD_EFFECT_DEVIL_POWER,
        .holdEffectParam = 30,
    ...
    {
        .name = _("CANDY BAG"),
        .itemId = ITEM_CANDY_POUCH,
        .price = 100,
        .holdEffect = HOLD_EFFECT_SWEET_POWER,
        .holdEffectParam = 30,
...
// TMs/HMs
    ...
    [ITEM_TM03_BUBBLE_BEAM] =
    {
        .name = _("TM03"),
        .itemId = ITEM_TM03_BUBBLE_BEAM,
        .price = 2000,
    ...
    [ITEM_TM06_HYPER_VOICE] =
    {
        .name = _("TM06"),
        .itemId = ITEM_TM06_HYPER_VOICE,
        .price = 3000,
    ...
    [ITEM_TM09_DRAIN_KISS] =
    {
        .name = _("TM09"),
        .itemId = ITEM_TM09_DRAIN_KISS,
        .price = 2000,
    ...
    [ITEM_TM10_DOUBLE_SLAP] =
    {
        .name = _("TM10"),
        .itemId = ITEM_TM10_DOUBLE_SLAP,
        .price = 2000,
    ...
    [ITEM_TM21_WEATHER_BALL] =
    {
        .name = _("TM21"),
        .itemId = ITEM_TM21_WEATHER_BALL,
        .price = 2000,
    ...
    [ITEM_TM23_IRON_TACKLE] =
    {
        .name = _("TM23"),
        .itemId = ITEM_TM23_IRON_TACKLE,
        .price = 3000,
    ...
    [ITEM_TM27_BODY_PRESS] =
    {
        .name = _("TM27"),
        .itemId = ITEM_TM27_BODY_PRESS,
        .price = 2000,
    ...
    [ITEM_TM34_COSMIC_PULSE] =
    {
        .name = _("TM34"),
        .itemId = ITEM_TM34_COSMIC_PULSE,
        .price = 2000,
    ...
    [ITEM_TM40_CRUSH_CLAW] =
    {
        .name = _("TM40"),
        .itemId = ITEM_TM40_CRUSH_CLAW,
        .price = 2000,
    ...
    [ITEM_TM43_DREAM_EATER] =
    {
        .name = _("TM43"),
        .itemId = ITEM_TM43_DREAM_EATER,
        .price = 2000,
    ...
    [ITEM_TM45_SLEEP_TALK] =
    {
        .name = _("TM45"),
        .itemId = ITEM_TM45_SLEEP_TALK,
        .price = 1000,
    ...
    [ITEM_HM02_SPACE_TRAVEL] =
    {
        .name = _("HM02"),
        .itemId = ITEM_HM02_SPACE_TRAVEL,
        .price = 0,
