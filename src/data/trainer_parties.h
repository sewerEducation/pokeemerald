...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .lvl = 39,
    .species = SPECIES_SANABLUE,
    .moves = {MOVE_SONIC_BOOM, MOVE_ROCK_SHOCK, MOVE_METAL_SOUND, MOVE_HEAVENBOLT}
    },
    {
    .iv = 250,
    .lvl = 39,
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky1[] = {
    ...
    .lvl = 13,
    .species = SPECIES_ZIGZAGOON,
    .moves = {MOVE_SAND_ATTACK, MOVE_HEADBUTT, MOVE_TAIL_WAG, MOVE_SURF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky2[] = {
    ...
    .moves = {MOVE_SAND_ATTACK, MOVE_PIN_MISSILE, MOVE_TAIL_WAG, MOVE_SURF}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TEETER_DANCE, MOVE_DIZZY_HEART, MOVE_FOCUS_BLAST, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .lvl = 28,
    .species = SPECIES_SANABLUE,
    .moves = {MOVE_HEAVENBOLT, MOVE_SUPERSONIC, MOVE_ROCK_SHOCK, MOVE_SONIC_BOOM}
    },
    {
    .iv = 100,
    .lvl = 28,
...
static const struct TrainerMonItemCustomMoves sParty_Mary[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FEINT_ATTACK, MOVE_COSMIC_PULSE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Wendy[] = {
    ...
    .lvl = 29,
    .species = SPECIES_PELIPPER,
    .moves = {MOVE_SPACE_TRAVEL, MOVE_WATER_GUN, MOVE_MIST, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy2[] = {
    ...
    .species = SPECIES_ZIGZAGOON,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_TACKLE, MOVE_TAIL_WAG, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Olivia[] = {
    ...
    .moves = {MOVE_ROCK_OUT, MOVE_FURY_SWIPES, MOVE_FAKE_OUT, MOVE_WATER_PULSE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kirk[] = {
    ...
    .lvl = 17,
    .species = SPECIES_ELECTRIKE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_ROCK_SHOCK, MOVE_SWEET_TALK, MOVE_LEER}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_KIRARIPINK,
    .moves = {MOVE_CHARGE, MOVE_COSMIC_PULSE, MOVE_SCREECH, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .lvl = 21,
    .species = SPECIES_BALTOY,
    .moves = {MOVE_TIDY_UP, MOVE_MUD_SLAP, MOVE_PSYBEAM, MOVE_ROCK_TOMB}
    },
    {
    .iv = 0,
    .lvl = 21,
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter3[] = {
    ...
    .lvl = 36,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_QUICK_ATTACK, MOVE_SWEET_TALK, MOVE_ODOR_SLEUTH, MOVE_ROAR}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter4[] = {
    ...
    .lvl = 39,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_QUICK_ATTACK, MOVE_SWEET_TALK, MOVE_ODOR_SLEUTH, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_HEAVENBOLT, MOVE_FACADE}
    },
    {
    .iv = 255,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_DEVIL_CLAW, MOVE_PROTECT, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 250,
    .lvl = 54,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_DRAGON_BREATH, MOVE_DEVIL_WALTZ, MOVE_AERIAL_ACE}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SMOKESCREEN, MOVE_DEVIL_WALTZ, MOVE_SURF, MOVE_BODY_SLAM}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_ASPEAR_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_DEVIL_CLAW, MOVE_ROCK_SLIDE, MOVE_VAMPIRE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_MEDITITE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_BLAST, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 19,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_KIRARIPINK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROLLOUT, MOVE_SWEET_TALK, MOVE_SELF_DESTRUCT, MOVE_COSMIC_PULSE}
    },
    {
    .iv = 200,
    .lvl = 20,
    .species = SPECIES_ELECTRIKE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_COSMIC_PULSE, MOVE_LEER, MOVE_QUICK_ATTACK, MOVE_HOWL}
    },
    {
    .iv = 220,
    .lvl = 22,
    .species = SPECIES_SANABLUE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUPERSONIC, MOVE_COSMIC_PULSE, MOVE_ROCK_SHOCK, MOVE_SONIC_BOOM}
    },
    {
    .iv = 250,
    .lvl = 24,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_CHERI_BERRY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_ROCK_SHOCK, MOVE_COSMIC_PULSE, MOVE_HOWL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PERISH_SONG, MOVE_COPYCAT, MOVE_SAFEGUARD, MOVE_AERIAL_ACE}
    },
    {
    .iv = 210,
    .lvl = 29,
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SAND_ATTACK, MOVE_FURY_ATTACK, MOVE_METAL_GALE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_BREATH, MOVE_DEVIL_WALTZ, MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_KateAndJoy[] = {
    ...
    .lvl = 32,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_FOCUS_BLAST, MOVE_YAWN, MOVE_SLACK_OFF, MOVE_FEINT_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg1[] = {
    ...
    .lvl = 15,
    .species = SPECIES_ZIGZAGOON,
    .moves = {MOVE_GROWL, MOVE_TAIL_WAG, MOVE_HEADBUTT, MOVE_ODOR_SLEUTH}
    },
    {
    .iv = 0,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .lvl = 17,
    .species = SPECIES_ZIGZAGOON,
    .moves = {MOVE_HEADBUTT, MOVE_SAND_ATTACK, MOVE_GROWL, MOVE_HEAVENBOLT}
    },
    {
    .iv = 150,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_Quincy[] = {
    ...
    .lvl = 43,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_ATTRACT, MOVE_ICE_BEAM, MOVE_HEAVENBOLT, MOVE_FLAMETHROWER}
    },
    {
    .iv = 100,
    .lvl = 43,
...
static const struct TrainerMonNoItemCustomMoves sParty_Katelynn[] = {
    ...
    .moves = {MOVE_SKILL_SWAP, MOVE_PSYCHIC, MOVE_HEAVENBOLT, MOVE_CALM_MIND}
    },
    {
    .iv = 100,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DEVIL_WALTZ, MOVE_EARTHQUAKE, MOVE_HYPER_BEAM, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMoves sParty_Dianne[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEAVENBOLT, MOVE_EARTHQUAKE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao1[] = {
    ...
    .lvl = 17,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_FOUL_SCENT, MOVE_TACKLE, MOVE_SMOG, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 0,
    .lvl = 17,
    ...
    .lvl = 17,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_FOUL_SCENT, MOVE_TACKLE, MOVE_SLUDGE, MOVE_SELF_DESTRUCT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao2[] = {
    ...
    .lvl = 24,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_FOUL_SCENT, MOVE_TACKLE, MOVE_SLUDGE, MOVE_NONE}
    },
    {
    .iv = 0,
    .lvl = 24,
...
static const struct TrainerMonNoItemCustomMoves sParty_Becky[] = {
    ...
    .lvl = 22,
    .species = SPECIES_MARILL,
    .moves = {MOVE_ROLLOUT, MOVE_BUBBLE_BEAM, MOVE_TAIL_WAG, MOVE_DEFENSE_CURL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AmyAndLiv5[] = {
    ...
    .lvl = 33,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_SWEET_TALK, MOVE_CHARGE, MOVE_FAKE_TEARS, MOVE_HELPING_HAND}
    },
    {
    .iv = 30,
    .lvl = 33,
    .species = SPECIES_MINUN,
    .moves = {MOVE_SWEET_TALK, MOVE_CHARGE, MOVE_CHARM, MOVE_HELPING_HAND}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Marley[] = {
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_ROAR, MOVE_ROCK_SHOCK, MOVE_HEAVENBOLT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 44,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_AERIAL_ACE, MOVE_SAFEGUARD, MOVE_DRAGON_BREATH, MOVE_DEVIL_WALTZ}
    },
    {
    .iv = 150,
    .lvl = 43,
    ...
    .lvl = 41,
    .species = SPECIES_SANABLUE,
    .moves = {MOVE_SUPERSONIC, MOVE_HEAVENBOLT, MOVE_TRI_ATTACK, MOVE_SCREECH}
    },
    {
    .iv = 250,
    .lvl = 45,
...
static const struct TrainerMonItemCustomMoves sParty_Athena[] = {
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_ROCK_SHOCK, MOVE_QUICK_ATTACK, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 32,
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
    ...
    .lvl = 17,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_BIDE, MOVE_DETECT, MOVE_CONFUSION, MOVE_HEAVEN_PUNCH}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_HEAVEN_PUNCH, MOVE_DETECT, MOVE_CONFUSION, MOVE_MEDITATE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    .lvl = 25,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TACKLE, MOVE_FOUL_SCENT, MOVE_SLUDGE, MOVE_SMOKESCREEN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Keigo[] = {
    ...
    .lvl = 28,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_FOUL_SCENT, MOVE_SELF_DESTRUCT, MOVE_SLUDGE, MOVE_SMOKESCREEN}
    },
    {
    .iv = 0,
    .lvl = 28,
...
static const struct TrainerMonNoItemCustomMoves sParty_JohnAndJay1[] = {
    ...
    .lvl = 39,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_FOCUS_BLAST, MOVE_ROCK_TOMB, MOVE_REST, MOVE_BELLY_DRUM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Leonel[] = {
    ...
    .lvl = 30,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_THUNDER, MOVE_QUICK_ATTACK, MOVE_ROCK_SHOCK, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_TACKLE, MOVE_EXPLOSION, MOVE_ROAR, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 37,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne5[] = {
    ...
    .species = SPECIES_HIJIRIPINK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_BLAST, MOVE_ROLLOUT, MOVE_EARTHQUAKE, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .species = SPECIES_MINAMIPINK,
    .heldItem = ITEM_RAWST_BERRY,
    .moves = {MOVE_KARATE_CHOP, MOVE_ROCK_SLIDE, MOVE_FOCUS_BLAST, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_MEDITITE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_FOCUS_BLAST}
    },
    {
    .iv = 255,
    .lvl = 35,
    ...
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_RAWST_BERRY,
    .moves = {MOVE_FAKE_OUT, MOVE_FOCUS_BLAST, MOVE_BELLY_DRUM, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LUNGE, MOVE_PROTECT, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_BLAST, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 45,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MEGA_KICK, MOVE_FOCUS_BLAST, MOVE_EARTHQUAKE, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 46,
    ...
    .species = SPECIES_MINAMIPINK,
    .heldItem = ITEM_ASPEAR_BERRY,
    .moves = {MOVE_CROSS_CHOP, MOVE_ROCK_SLIDE, MOVE_FOCUS_BLAST, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_PROTECT, MOVE_ROCK_SHOCK, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 255,
    .lvl = 36,
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_ASPEAR_BERRY,
    .moves = {MOVE_BITE, MOVE_ROCK_SHOCK, MOVE_THUNDER, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson3[] = {
    ...
    .species = SPECIES_NANAMIBASE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_SLAM, MOVE_RAIN_DANCE, MOVE_COSMIC_PULSE}
    },
    {
    .iv = 255,
    .lvl = 41,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_SING, MOVE_SKILL_SWAP, MOVE_FOCUS_BLAST}
    },
    {
    .iv = 255,
    .lvl = 42,
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_ASPEAR_BERRY,
    .moves = {MOVE_HYPER_BEAM, MOVE_FLAMETHROWER, MOVE_HEAVENBOLT, MOVE_SHADOW_BALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman5[] = {
    ...
    .species = SPECIES_BLISSEY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_SING, MOVE_SKILL_SWAP, MOVE_FOCUS_BLAST}
    },
    {
    .iv = 255,
    .lvl = 55,
...
static const struct TrainerMonItemCustomMoves sParty_Winona2[] = {
    ...
    .heldItem = ITEM_ASPEAR_BERRY,
    .moves = {MOVE_ROCK_SHOCK, MOVE_HEAVENBOLT, MOVE_PROTECT, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WHIRLWIND, MOVE_SPIKES, MOVE_METAL_GALE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_AERIAL_ACE, MOVE_REST, MOVE_DEVIL_WALTZ, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona5[] = {
    ...
    .heldItem = ITEM_ASPEAR_BERRY,
    .moves = {MOVE_HYPER_BEAM, MOVE_HEAVENBOLT, MOVE_EARTHQUAKE, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 58,
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_SKY_ATTACK, MOVE_REST, MOVE_DEVIL_WALTZ, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    ...
    .species = SPECIES_ILLUMISE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_COSMIC_PULSE, MOVE_QUICK_ATTACK, MOVE_CHARM, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_VOLBEAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_COSMIC_PULSE, MOVE_QUICK_ATTACK, MOVE_CONFUSE_RAY, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_AERIAL_ACE, MOVE_SPIKES, MOVE_METAL_GALE}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_EARTHQUAKE, MOVE_SOLAR_BEAM, MOVE_DEVIL_CLAW}
    },
    {
    .iv = 255,
    .lvl = 76,
