...
const u32 gMonStillFrontPic_MioBlue[] = INCBIN_U32("graphics/pokemon/caterpie/front.4bpp.lz");
const u32 gMonPalette_MioBlue[] = INCBIN_U32("graphics/pokemon/caterpie/normal.gbapal.lz");
const u32 gMonBackPic_MioBlue[] = INCBIN_U32("graphics/pokemon/caterpie/back.4bpp.lz");
const u32 gMonShinyPalette_MioBlue[] = INCBIN_U32("graphics/pokemon/caterpie/shiny.gbapal.lz");
const u8 gMonIcon_MioBlue[] = INCBIN_U8("graphics/pokemon/caterpie/icon.4bpp");
const u8 gMonFootprint_MioBlue[] = INCBIN_U8("graphics/idols/footprints/SR.1bpp");

const u32 gMonStillFrontPic_MioGold[] = INCBIN_U32("graphics/pokemon/metapod/front.4bpp.lz");
const u32 gMonPalette_MioGold[] = INCBIN_U32("graphics/pokemon/metapod/normal.gbapal.lz");
const u32 gMonBackPic_MioGold[] = INCBIN_U32("graphics/pokemon/metapod/back.4bpp.lz");
const u32 gMonShinyPalette_MioGold[] = INCBIN_U32("graphics/pokemon/metapod/shiny.gbapal.lz");
const u8 gMonIcon_MioGold[] = INCBIN_U8( "graphics/pokemon/metapod/icon.4bpp");
const u8 gMonFootprint_MioGold[] = INCBIN_U8("graphics/idols/footprints/SR.1bpp");

const u32 gMonStillFrontPic_MioPink[] = INCBIN_U32("graphics/pokemon/butterfree/front.4bpp.lz");
const u32 gMonPalette_MioPink[] = INCBIN_U32("graphics/pokemon/butterfree/normal.gbapal.lz");
const u32 gMonBackPic_MioPink[] = INCBIN_U32("graphics/pokemon/butterfree/back.4bpp.lz");
const u32 gMonShinyPalette_MioPink[] = INCBIN_U32("graphics/pokemon/butterfree/shiny.gbapal.lz");
const u8 gMonIcon_MioPink[] = INCBIN_U8("graphics/pokemon/butterfree/icon.4bpp");
