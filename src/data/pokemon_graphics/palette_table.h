const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(UZUKIBASE, gMonPalette_UzukiBase),
    SPECIES_PAL(UZUKIBLUE, gMonPalette_UzukiBlue),
    SPECIES_PAL(UZUKIGOLD, gMonPalette_UzukiGold),
    SPECIES_PAL(UZUKIPINK, gMonPalette_UzukiPink),
    SPECIES_PAL(RINBASE, gMonPalette_RinBase),
    SPECIES_PAL(RINBLUE, gMonPalette_RinBlue),
    SPECIES_PAL(RINGOLD, gMonPalette_RinGold),
    SPECIES_PAL(RINPINK, gMonPalette_RinPink),
    SPECIES_PAL(MIOBASE, gMonPalette_MioBase),
    SPECIES_PAL(MIOBLUE, gMonPalette_MioBlue),
    SPECIES_PAL(MIOGOLD, gMonPalette_MioGold),
    SPECIES_PAL(MIOPINK, gMonPalette_MioPink),
    SPECIES_PAL(MIRIABASE, gMonPalette_MiriaBase),
    SPECIES_PAL(MIRIABLUE, gMonPalette_MiriaBlue),
    SPECIES_PAL(MIRIAGOLD, gMonPalette_MiriaGold),
    SPECIES_PAL(MIRIAPINK, gMonPalette_MiriaPink),
    SPECIES_PAL(KAORUBASE, gMonPalette_KaoruBase),
    SPECIES_PAL(KAORUBLUE, gMonPalette_KaoruBlue),
    SPECIES_PAL(KAORUGOLD, gMonPalette_KaoruGold),
    SPECIES_PAL(KAORUPINK, gMonPalette_KaoruPink),
    SPECIES_PAL(RIINABASE, gMonPalette_RiinaBase),
    SPECIES_PAL(RIINABLUE, gMonPalette_RiinaBlue),
    SPECIES_PAL(RIINAGOLD, gMonPalette_RiinaGold),
    SPECIES_PAL(RIINAPINK, gMonPalette_RiinaPink),
    SPECIES_PAL(NANAMIBASE, gMonPalette_NanamiBase),
    SPECIES_PAL(NANAMIBLUE, gMonPalette_NanamiBlue),
    SPECIES_PAL(NANAMIGOLD, gMonPalette_NanamiGold),
    SPECIES_PAL(NANAMIPINK, gMonPalette_NanamiPink),
    SPECIES_PAL(ATSUMIBASE, gMonPalette_AtsumiBase),
    SPECIES_PAL(ATSUMIBLUE, gMonPalette_AtsumiBlue),
    SPECIES_PAL(ATSUMIGOLD, gMonPalette_AtsumiGold),
    SPECIES_PAL(ATSUMIPINK, gMonPalette_AtsumiPink),
    SPECIES_PAL(KOZUEBASE, gMonPalette_KozueBase),
    SPECIES_PAL(KOZUEBLUE, gMonPalette_KozueBlue),
    SPECIES_PAL(KOZUEGOLD, gMonPalette_KozueGold),
    SPECIES_PAL(KOZUEPINK, gMonPalette_KozuePink),
    SPECIES_PAL(NINABASE, gMonPalette_NinaBase),
    SPECIES_PAL(NINABLUE, gMonPalette_NinaBlue),
    SPECIES_PAL(NINAGOLD, gMonPalette_NinaGold),
    SPECIES_PAL(NINAPINK, gMonPalette_NinaPink),
    SPECIES_PAL(SACHIKOBASE, gMonPalette_SachikoBase),
    SPECIES_PAL(SACHIKOBLUE, gMonPalette_SachikoBlue),
    SPECIES_PAL(SACHIKOGOLD, gMonPalette_SachikoGold),
    SPECIES_PAL(SACHIKOPINK, gMonPalette_SachikoPink),
    SPECIES_PAL(LAYLABASE, gMonPalette_LaylaBase),
    SPECIES_PAL(LAYLABLUE, gMonPalette_LaylaBlue),
    SPECIES_PAL(LAYLAGOLD, gMonPalette_LaylaGold),
    SPECIES_PAL(LAYLAPINK, gMonPalette_LaylaPink),
    SPECIES_PAL(REINABASE, gMonPalette_ReinaBase),
    SPECIES_PAL(REINABLUE, gMonPalette_ReinaBlue),
    SPECIES_PAL(REINAGOLD, gMonPalette_ReinaGold),
    SPECIES_PAL(REINAPINK, gMonPalette_ReinaPink),
    SPECIES_PAL(MOMOKABASE, gMonPalette_MomokaBase),
    SPECIES_PAL(MOMOKABLUE, gMonPalette_MomokaBlue),
    SPECIES_PAL(MOMOKAGOLD, gMonPalette_MomokaGold),
    SPECIES_PAL(MOMOKAPINK, gMonPalette_MomokaPink),
    SPECIES_PAL(ARISUBASE, gMonPalette_ArisuBase),
    SPECIES_PAL(ARISUBLUE, gMonPalette_ArisuBlue),
    SPECIES_PAL(ARISUGOLD, gMonPalette_ArisuGold),
    SPECIES_PAL(ARISUPINK, gMonPalette_ArisuPink),
    SPECIES_PAL(AIRIBASE, gMonPalette_AiriBase),
    SPECIES_PAL(AIRIBLUE, gMonPalette_AiriBlue),
    SPECIES_PAL(AIRIGOLD, gMonPalette_AiriGold),
    SPECIES_PAL(AIRIPINK, gMonPalette_AiriPink),
    SPECIES_PAL(MINAMIBASE, gMonPalette_MinamiBase),
    SPECIES_PAL(MINAMIBLUE, gMonPalette_MinamiBlue),
    SPECIES_PAL(MINAMIGOLD, gMonPalette_MinamiGold),
    SPECIES_PAL(MINAMIPINK, gMonPalette_MinamiPink),
    SPECIES_PAL(ANASTASIABASE, gMonPalette_AnastasiaBase),
    SPECIES_PAL(ANASTASIABLUE, gMonPalette_AnastasiaBlue),
    SPECIES_PAL(ANASTASIAGOLD, gMonPalette_AnastasiaGold),
    SPECIES_PAL(ANASTASIAPINK, gMonPalette_AnastasiaPink),
    SPECIES_PAL(HIJIRIBASE, gMonPalette_HijiriBase),
    SPECIES_PAL(HIJIRIBLUE, gMonPalette_HijiriBlue),
    SPECIES_PAL(HIJIRIGOLD, gMonPalette_HijiriGold),
    SPECIES_PAL(HIJIRIPINK, gMonPalette_HijiriPink),
    SPECIES_PAL(RISABASE, gMonPalette_RisaBase),
    SPECIES_PAL(RISABLUE, gMonPalette_RisaBlue),
    SPECIES_PAL(RISAGOLD, gMonPalette_RisaGold),
    SPECIES_PAL(RISAPINK, gMonPalette_RisaPink),
    SPECIES_PAL(SANABASE, gMonPalette_SanaBase),
    SPECIES_PAL(SANABLUE, gMonPalette_SanaBlue),
    SPECIES_PAL(SANAGOLD, gMonPalette_SanaGold),
    SPECIES_PAL(SANAPINK, gMonPalette_SanaPink),
    SPECIES_PAL(HARUBASE, gMonPalette_HaruBase),
    SPECIES_PAL(HARUBLUE, gMonPalette_HaruBlue),
    SPECIES_PAL(HARUGOLD, gMonPalette_HaruGold),
    SPECIES_PAL(HARUPINK, gMonPalette_HaruPink),
    SPECIES_PAL(MIREIBASE, gMonPalette_MireiBase),
    SPECIES_PAL(MIREIBLUE, gMonPalette_MireiBlue),
    SPECIES_PAL(MIREIGOLD, gMonPalette_MireiGold),
    SPECIES_PAL(MIREIPINK, gMonPalette_MireiPink),
    SPECIES_PAL(ANZUBASE, gMonPalette_AnzuBase),
    SPECIES_PAL(ANZUBLUE, gMonPalette_AnzuBlue),
    SPECIES_PAL(ANZUGOLD, gMonPalette_AnzuGold),
    SPECIES_PAL(ANZUPINK, gMonPalette_AnzuPink),
    SPECIES_PAL(KIRARIBASE, gMonPalette_KirariBase),
    SPECIES_PAL(KIRARIBLUE, gMonPalette_KirariBlue),
    SPECIES_PAL(KIRARIGOLD, gMonPalette_KirariGold),
    SPECIES_PAL(KIRARIPINK, gMonPalette_KirariPink),
    SPECIES_PAL(NATALIABASE, gMonPalette_NataliaBase),
    SPECIES_PAL(NATALIABLUE, gMonPalette_NataliaBlue),
    SPECIES_PAL(NATALIAGOLD, gMonPalette_NataliaGold),
    SPECIES_PAL(NATALIAPINK, gMonPalette_NataliaPink),
