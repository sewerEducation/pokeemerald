const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(UZUKIBASE, gMonBackPic_UzukiBase),
    SPECIES_SPRITE(UZUKIBLUE, gMonBackPic_UzukiBlue),
    SPECIES_SPRITE(UZUKIGOLD, gMonBackPic_UzukiGold),
    SPECIES_SPRITE(UZUKIPINK, gMonBackPic_UzukiPink),
    SPECIES_SPRITE(RINBASE, gMonBackPic_RinBase),
    SPECIES_SPRITE(RINBLUE, gMonBackPic_RinBlue),
    SPECIES_SPRITE(RINGOLD, gMonBackPic_RinGold),
    SPECIES_SPRITE(RINPINK, gMonBackPic_RinPink),
    SPECIES_SPRITE(MIOBASE, gMonBackPic_MioBase),
    SPECIES_SPRITE(MIOBLUE, gMonBackPic_MioBlue),
    SPECIES_SPRITE(MIOGOLD, gMonBackPic_MioGold),
    SPECIES_SPRITE(MIOPINK, gMonBackPic_MioPink),
    SPECIES_SPRITE(MIRIABASE, gMonBackPic_MiriaBase),
    SPECIES_SPRITE(MIRIABLUE, gMonBackPic_MiriaBlue),
    SPECIES_SPRITE(MIRIAGOLD, gMonBackPic_MiriaGold),
    SPECIES_SPRITE(MIRIAPINK, gMonBackPic_MiriaPink),
    SPECIES_SPRITE(KAORUBASE, gMonBackPic_KaoruBase),
    SPECIES_SPRITE(KAORUBLUE, gMonBackPic_KaoruBlue),
    SPECIES_SPRITE(KAORUGOLD, gMonBackPic_KaoruGold),
    SPECIES_SPRITE(KAORUPINK, gMonBackPic_KaoruPink),
    SPECIES_SPRITE(RIINABASE, gMonBackPic_RiinaBase),
    SPECIES_SPRITE(RIINABLUE, gMonBackPic_RiinaBlue),
    SPECIES_SPRITE(RIINAGOLD, gMonBackPic_RiinaGold),
    SPECIES_SPRITE(RIINAPINK, gMonBackPic_RiinaPink),
    SPECIES_SPRITE(NANAMIBASE, gMonBackPic_NanamiBase),
    SPECIES_SPRITE(NANAMIBLUE, gMonBackPic_NanamiBlue),
    SPECIES_SPRITE(NANAMIGOLD, gMonBackPic_NanamiGold),
    SPECIES_SPRITE(NANAMIPINK, gMonBackPic_NanamiPink),
    SPECIES_SPRITE(ATSUMIBASE, gMonBackPic_AtsumiBase),
    SPECIES_SPRITE(ATSUMIBLUE, gMonBackPic_AtsumiBlue),
    SPECIES_SPRITE(ATSUMIGOLD, gMonBackPic_AtsumiGold),
    SPECIES_SPRITE(ATSUMIPINK, gMonBackPic_AtsumiPink),
    SPECIES_SPRITE(KOZUEBASE, gMonBackPic_KozueBase),
    SPECIES_SPRITE(KOZUEBLUE, gMonBackPic_KozueBlue),
    SPECIES_SPRITE(KOZUEGOLD, gMonBackPic_KozueGold),
    SPECIES_SPRITE(KOZUEPINK, gMonBackPic_KozuePink),
    SPECIES_SPRITE(NINABASE, gMonBackPic_NinaBase),
    SPECIES_SPRITE(NINABLUE, gMonBackPic_NinaBlue),
    SPECIES_SPRITE(NINAGOLD, gMonBackPic_NinaGold),
    SPECIES_SPRITE(NINAPINK, gMonBackPic_NinaPink),
    SPECIES_SPRITE(SACHIKOBASE, gMonBackPic_SachikoBase),
    SPECIES_SPRITE(SACHIKOBLUE, gMonBackPic_SachikoBlue),
    SPECIES_SPRITE(SACHIKOGOLD, gMonBackPic_SachikoGold),
    SPECIES_SPRITE(SACHIKOPINK, gMonBackPic_SachikoPink),
    SPECIES_SPRITE(LAYLABASE, gMonBackPic_LaylaBase),
    SPECIES_SPRITE(LAYLABLUE, gMonBackPic_LaylaBlue),
    SPECIES_SPRITE(LAYLAGOLD, gMonBackPic_LaylaGold),
    SPECIES_SPRITE(LAYLAPINK, gMonBackPic_LaylaPink),
    SPECIES_SPRITE(REINABASE, gMonBackPic_ReinaBase),
    SPECIES_SPRITE(REINABLUE, gMonBackPic_ReinaBlue),
    SPECIES_SPRITE(REINAGOLD, gMonBackPic_ReinaGold),
    SPECIES_SPRITE(REINAPINK, gMonBackPic_ReinaPink),
    SPECIES_SPRITE(MOMOKABASE, gMonBackPic_MomokaBase),
    SPECIES_SPRITE(MOMOKABLUE, gMonBackPic_MomokaBlue),
    SPECIES_SPRITE(MOMOKAGOLD, gMonBackPic_MomokaGold),
    SPECIES_SPRITE(MOMOKAPINK, gMonBackPic_MomokaPink),
    SPECIES_SPRITE(ARISUBASE, gMonBackPic_ArisuBase),
    SPECIES_SPRITE(ARISUBLUE, gMonBackPic_ArisuBlue),
    SPECIES_SPRITE(ARISUGOLD, gMonBackPic_ArisuGold),
    SPECIES_SPRITE(ARISUPINK, gMonBackPic_ArisuPink),
    SPECIES_SPRITE(AIRIBASE, gMonBackPic_AiriBase),
    SPECIES_SPRITE(AIRIBLUE, gMonBackPic_AiriBlue),
    SPECIES_SPRITE(AIRIGOLD, gMonBackPic_AiriGold),
    SPECIES_SPRITE(AIRIPINK, gMonBackPic_AiriPink),
    SPECIES_SPRITE(MINAMIBASE, gMonBackPic_MinamiBase),
    SPECIES_SPRITE(MINAMIBLUE, gMonBackPic_MinamiBlue),
    SPECIES_SPRITE(MINAMIGOLD, gMonBackPic_MinamiGold),
    SPECIES_SPRITE(MINAMIPINK, gMonBackPic_MinamiPink),
    SPECIES_SPRITE(ANASTASIABASE, gMonBackPic_AnastasiaBase),
    SPECIES_SPRITE(ANASTASIABLUE, gMonBackPic_AnastasiaBlue),
    SPECIES_SPRITE(ANASTASIAGOLD, gMonBackPic_AnastasiaGold),
    SPECIES_SPRITE(ANASTASIAPINK, gMonBackPic_AnastasiaPink),
    SPECIES_SPRITE(HIJIRIBASE, gMonBackPic_HijiriBase),
    SPECIES_SPRITE(HIJIRIBLUE, gMonBackPic_HijiriBlue),
    SPECIES_SPRITE(HIJIRIGOLD, gMonBackPic_HijiriGold),
    SPECIES_SPRITE(HIJIRIPINK, gMonBackPic_HijiriPink),
    SPECIES_SPRITE(RISABASE, gMonBackPic_RisaBase),
    SPECIES_SPRITE(RISABLUE, gMonBackPic_RisaBlue),
    SPECIES_SPRITE(RISAGOLD, gMonBackPic_RisaGold),
    SPECIES_SPRITE(RISAPINK, gMonBackPic_RisaPink),
    SPECIES_SPRITE(SANABASE, gMonBackPic_SanaBase),
    SPECIES_SPRITE(SANABLUE, gMonBackPic_SanaBlue),
    SPECIES_SPRITE(SANAGOLD, gMonBackPic_SanaGold),
    SPECIES_SPRITE(SANAPINK, gMonBackPic_SanaPink),
    SPECIES_SPRITE(HARUBASE, gMonBackPic_HaruBase),
    SPECIES_SPRITE(HARUBLUE, gMonBackPic_HaruBlue),
    SPECIES_SPRITE(HARUGOLD, gMonBackPic_HaruGold),
    SPECIES_SPRITE(HARUPINK, gMonBackPic_HaruPink),
    SPECIES_SPRITE(MIREIBASE, gMonBackPic_MireiBase),
    SPECIES_SPRITE(MIREIBLUE, gMonBackPic_MireiBlue),
    SPECIES_SPRITE(MIREIGOLD, gMonBackPic_MireiGold),
    SPECIES_SPRITE(MIREIPINK, gMonBackPic_MireiPink),
    SPECIES_SPRITE(ANZUBASE, gMonBackPic_AnzuBase),
    SPECIES_SPRITE(ANZUBLUE, gMonBackPic_AnzuBlue),
    SPECIES_SPRITE(ANZUGOLD, gMonBackPic_AnzuGold),
    SPECIES_SPRITE(ANZUPINK, gMonBackPic_AnzuPink),
    SPECIES_SPRITE(KIRARIBASE, gMonBackPic_KirariBase),
    SPECIES_SPRITE(KIRARIBLUE, gMonBackPic_KirariBlue),
    SPECIES_SPRITE(KIRARIGOLD, gMonBackPic_KirariGold),
    SPECIES_SPRITE(KIRARIPINK, gMonBackPic_KirariPink),
    SPECIES_SPRITE(NATALIABASE, gMonBackPic_NataliaBase),
    SPECIES_SPRITE(NATALIABLUE, gMonBackPic_NataliaBlue),
    SPECIES_SPRITE(NATALIAGOLD, gMonBackPic_NataliaGold),
    SPECIES_SPRITE(NATALIAPINK, gMonBackPic_NataliaPink),
