...
{
    [SPECIES_NONE] = gMonFootprint_UzukiBase,
    [SPECIES_UZUKIBASE] = gMonFootprint_UzukiBase,
    [SPECIES_UZUKIBLUE] = gMonFootprint_UzukiBlue,
    [SPECIES_UZUKIGOLD] = gMonFootprint_UzukiGold,
    [SPECIES_UZUKIPINK] = gMonFootprint_UzukiPink,
    [SPECIES_RINBASE] = gMonFootprint_RinBase,
    [SPECIES_RINBLUE] = gMonFootprint_RinBlue,
    [SPECIES_RINGOLD] = gMonFootprint_RinGold,
    [SPECIES_RINPINK] = gMonFootprint_RinPink,
    [SPECIES_MIOBASE] = gMonFootprint_MioBase,
    [SPECIES_MIOBLUE] = gMonFootprint_MioBlue,
    [SPECIES_MIOGOLD] = gMonFootprint_MioGold,
    [SPECIES_MIOPINK] = gMonFootprint_MioPink,
    [SPECIES_MIRIABASE] = gMonFootprint_MiriaBase,
    [SPECIES_MIRIABLUE] = gMonFootprint_MiriaBlue,
    [SPECIES_MIRIAGOLD] = gMonFootprint_MiriaGold,
    [SPECIES_MIRIAPINK] = gMonFootprint_MiriaPink,
    [SPECIES_KAORUBASE] = gMonFootprint_KaoruBase,
    [SPECIES_KAORUBLUE] = gMonFootprint_KaoruBlue,
    [SPECIES_KAORUGOLD] = gMonFootprint_KaoruGold,
    [SPECIES_KAORUPINK] = gMonFootprint_KaoruPink,
    [SPECIES_RIINABASE] = gMonFootprint_RiinaBase,
    [SPECIES_RIINABLUE] = gMonFootprint_RiinaBlue,
    [SPECIES_RIINAGOLD] = gMonFootprint_RiinaGold,
    [SPECIES_RIINAPINK] = gMonFootprint_RiinaPink,
    [SPECIES_NANAMIBASE] = gMonFootprint_NanamiBase,
    [SPECIES_NANAMIBLUE] = gMonFootprint_NanamiBlue,
    [SPECIES_NANAMIGOLD] = gMonFootprint_NanamiGold,
    [SPECIES_NANAMIPINK] = gMonFootprint_NanamiPink,
    [SPECIES_ATSUMIBASE] = gMonFootprint_AtsumiBase,
    [SPECIES_ATSUMIBLUE] = gMonFootprint_AtsumiBlue,
    [SPECIES_ATSUMIGOLD] = gMonFootprint_AtsumiGold,
    [SPECIES_ATSUMIPINK] = gMonFootprint_AtsumiPink,
    [SPECIES_KOZUEBASE] = gMonFootprint_KozueBase,
    [SPECIES_KOZUEBLUE] = gMonFootprint_KozueBlue,
    [SPECIES_KOZUEGOLD] = gMonFootprint_KozueGold,
    [SPECIES_KOZUEPINK] = gMonFootprint_KozuePink,
    [SPECIES_NINABASE] = gMonFootprint_NinaBase,
    [SPECIES_NINABLUE] = gMonFootprint_NinaBlue,
    [SPECIES_NINAGOLD] = gMonFootprint_NinaGold,
    [SPECIES_NINAPINK] = gMonFootprint_NinaPink,
    [SPECIES_SACHIKOBASE] = gMonFootprint_SachikoBase,
    [SPECIES_SACHIKOBLUE] = gMonFootprint_SachikoBlue,
    [SPECIES_SACHIKOGOLD] = gMonFootprint_SachikoGold,
    [SPECIES_SACHIKOPINK] = gMonFootprint_SachikoPink,
    [SPECIES_LAYLABASE] = gMonFootprint_LaylaBase,
    [SPECIES_LAYLABLUE] = gMonFootprint_LaylaBlue,
    [SPECIES_LAYLAGOLD] = gMonFootprint_LaylaGold,
    [SPECIES_LAYLAPINK] = gMonFootprint_LaylaPink,
    [SPECIES_REINABASE] = gMonFootprint_ReinaBase,
    [SPECIES_REINABLUE] = gMonFootprint_ReinaBlue,
    [SPECIES_REINAGOLD] = gMonFootprint_ReinaGold,
    [SPECIES_REINAPINK] = gMonFootprint_ReinaPink,
    [SPECIES_MOMOKABASE] = gMonFootprint_MomokaBase,
    [SPECIES_MOMOKABLUE] = gMonFootprint_MomokaBlue,
    [SPECIES_MOMOKAGOLD] = gMonFootprint_MomokaGold,
    [SPECIES_MOMOKAPINK] = gMonFootprint_MomokaPink,
    [SPECIES_ARISUBASE] = gMonFootprint_ArisuBase,
    [SPECIES_ARISUBLUE] = gMonFootprint_ArisuBlue,
    [SPECIES_ARISUGOLD] = gMonFootprint_ArisuGold,
    [SPECIES_ARISUPINK] = gMonFootprint_ArisuPink,
    [SPECIES_AIRIBASE] = gMonFootprint_AiriBase,
    [SPECIES_AIRIBLUE] = gMonFootprint_AiriBlue,
    [SPECIES_AIRIGOLD] = gMonFootprint_AiriGold,
    [SPECIES_AIRIPINK] = gMonFootprint_AiriPink,
    [SPECIES_MINAMIBASE] = gMonFootprint_MinamiBase,
    [SPECIES_MINAMIBLUE] = gMonFootprint_MinamiBlue,
    [SPECIES_MINAMIGOLD] = gMonFootprint_MinamiGold,
    [SPECIES_MINAMIPINK] = gMonFootprint_MinamiPink,
    [SPECIES_ANASTASIABASE] = gMonFootprint_AnastasiaBase,
    [SPECIES_ANASTASIABLUE] = gMonFootprint_AnastasiaBlue,
    [SPECIES_ANASTASIAGOLD] = gMonFootprint_AnastasiaGold,
    [SPECIES_ANASTASIAPINK] = gMonFootprint_AnastasiaPink,
    [SPECIES_HIJIRIBASE] = gMonFootprint_HijiriBase,
    [SPECIES_HIJIRIBLUE] = gMonFootprint_HijiriBlue,
    [SPECIES_HIJIRIGOLD] = gMonFootprint_HijiriGold,
    [SPECIES_HIJIRIPINK] = gMonFootprint_HijiriPink,
    [SPECIES_RISABASE] = gMonFootprint_RisaBase,
    [SPECIES_RISABLUE] = gMonFootprint_RisaBlue,
    [SPECIES_RISAGOLD] = gMonFootprint_RisaGold,
    [SPECIES_RISAPINK] = gMonFootprint_RisaPink,
    [SPECIES_SANABASE] = gMonFootprint_SanaBase,
    [SPECIES_SANABLUE] = gMonFootprint_SanaBlue,
    [SPECIES_SANAGOLD] = gMonFootprint_SanaGold,
    [SPECIES_SANAPINK] = gMonFootprint_SanaPink,
    [SPECIES_HARUBASE] = gMonFootprint_HaruBase,
    [SPECIES_HARUBLUE] = gMonFootprint_HaruBlue,
    [SPECIES_HARUGOLD] = gMonFootprint_HaruGold,
    [SPECIES_HARUPINK] = gMonFootprint_HaruPink,
    [SPECIES_MIREIBASE] = gMonFootprint_MireiBase,
    [SPECIES_MIREIBLUE] = gMonFootprint_MireiBlue,
    [SPECIES_MIREIGOLD] = gMonFootprint_MireiGold,
    [SPECIES_MIREIPINK] = gMonFootprint_MireiPink,
    [SPECIES_ANZUBASE] = gMonFootprint_AnzuBase,
    [SPECIES_ANZUBLUE] = gMonFootprint_AnzuBlue,
    [SPECIES_ANZUGOLD] = gMonFootprint_AnzuGold,
    [SPECIES_ANZUPINK] = gMonFootprint_AnzuPink,
    [SPECIES_KIRARIBASE] = gMonFootprint_KirariBase,
    [SPECIES_KIRARIBLUE] = gMonFootprint_KirariBlue,
    [SPECIES_KIRARIGOLD] = gMonFootprint_KirariGold,
    [SPECIES_KIRARIPINK] = gMonFootprint_KirariPink,
    [SPECIES_NATALIABASE] = gMonFootprint_NataliaBase,
    [SPECIES_NATALIABLUE] = gMonFootprint_NataliaBlue,
    [SPECIES_NATALIAGOLD] = gMonFootprint_NataliaGold,
    [SPECIES_NATALIAPINK] = gMonFootprint_NataliaPink,
    ...
    [SPECIES_EGG] = gMonFootprint_UzukiBase,
};
