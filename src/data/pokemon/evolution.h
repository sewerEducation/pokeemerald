const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_VULPIX]     = {{EVO_ITEM, ITEM_PINK_SLIPPER, SPECIES_NINETALES}},
    ...
    [SPECIES_GROWLITHE]  = {{EVO_ITEM, ITEM_PINK_SLIPPER, SPECIES_ARCANINE}},
    [SPECIES_POLIWAG]    = {{EVO_LEVEL, 25, SPECIES_POLIWHIRL}},
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_BLUE_SLIPPER, SPECIES_POLIWRATH},
