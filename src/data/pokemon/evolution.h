const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MIRIABASE]     = {{EVO_LEVEL,  7, SPECIES_MIRIABLUE}},
    [SPECIES_MIRIABLUE]     = {{EVO_LEVEL, 10, SPECIES_MIRIAGOLD}},
    [SPECIES_MIRIAPINK]     = {{EVO_LEVEL, 18, SPECIES_PIDGEOTTO}},
    ...
    [SPECIES_PIKACHU]    = {{EVO_ITEM, ITEM_GOLD_SLIPPER, SPECIES_RAICHU}},
