...
const u8 *const gItemEffectTable[] =
{
    ...
    [ITEM_PINK_SLIPPER - ITEM_POTION]    = gItemEffect_FireStone,
    [ITEM_GOLD_SLIPPER - ITEM_POTION] = gItemEffect_ThunderStone,
    [ITEM_BLUE_SLIPPER - ITEM_POTION]   = gItemEffect_WaterStone,
