const u16 gTutorMoves[TUTOR_MOVE_COUNT] =
{
    ...
    [TUTOR_MOVE_ROCK_SHOCK] = MOVE_ROCK_SHOCK,
    ...
    [TUTOR_MOVE_SPEED_STAR] = MOVE_SPEED_STAR,
    [TUTOR_MOVE_DEFENSE_CURL] = MOVE_DEFENSE_CURL,
    [TUTOR_MOVE_HEAVEN_PUNCH] = MOVE_HEAVEN_PUNCH,
