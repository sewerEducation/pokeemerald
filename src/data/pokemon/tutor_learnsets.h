...
static const u32 sTutorLearnsets[] =
{
    ...
    [SPECIES_CHARMELEON]       = (TUTOR(MOVE_ROLE_PLAY)
    ...
    [SPECIES_CHARIZARD]        = (TUTOR(MOVE_ROLE_PLAY)
                                | TUTOR(MOVE_SWORDS_DANCE)
                                | TUTOR(MOVE_ROCK_OUT)
                                | TUTOR(MOVE_BODY_SLAM)
                                | TUTOR(MOVE_DOUBLE_EDGE)
    ...
    [SPECIES_SQUIRTLE]         = (TUTOR(MOVE_ROLE_PLAY)
                                | TUTOR(MOVE_ROCK_OUT)
                                | TUTOR(MOVE_BODY_SLAM)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_GRASS_WHISTLE)
    ...
    [SPECIES_WARTORTLE]        = (TUTOR(MOVE_ROLE_PLAY)
                                | TUTOR(MOVE_ROCK_OUT)
                                | TUTOR(MOVE_BODY_SLAM)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_GRASS_WHISTLE)
    ...
    [SPECIES_BLASTOISE]        = (TUTOR(MOVE_ROLE_PLAY)
                                | TUTOR(MOVE_ROCK_OUT)
                                | TUTOR(MOVE_BODY_SLAM)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_GRASS_WHISTLE)
