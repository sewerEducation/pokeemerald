...
static const u32 sTutorLearnsets[] =
{
    ...
    [SPECIES_PIDGEOTTO]        = (TUTOR(MOVE_ROLE_PLAY)
    ...
    [SPECIES_PIKACHU]          = (TUTOR(MOVE_ROLE_PLAY)
                                | TUTOR(MOVE_ROCK_OUT)
                                | TUTOR(MOVE_BODY_SLAM)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_GRASS_WHISTLE)
    ...
    [SPECIES_RAICHU]           = (TUTOR(MOVE_ROLE_PLAY)
                                | TUTOR(MOVE_ROCK_OUT)
                                | TUTOR(MOVE_BODY_SLAM)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_GRASS_WHISTLE)
    ...
    [SPECIES_NIDOQUEEN]        = (TUTOR(MOVE_ROLE_PLAY)
                                | TUTOR(MOVE_ROCK_OUT)
                                | TUTOR(MOVE_BODY_SLAM)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_GRASS_WHISTLE)
    ...
    [SPECIES_NIDOKING]         = (TUTOR(MOVE_ROLE_PLAY)
                                | TUTOR(MOVE_ROCK_OUT)
                                | TUTOR(MOVE_BODY_SLAM)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_GRASS_WHISTLE)
    ...
    [SPECIES_CLEFAIRY]         = (TUTOR(MOVE_ROLE_PLAY)
                                | TUTOR(MOVE_ROCK_OUT)
                                | TUTOR(MOVE_BODY_SLAM)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_GRASS_WHISTLE)
    ...
    [SPECIES_CLEFABLE]         = (TUTOR(MOVE_ROLE_PLAY)
                                | TUTOR(MOVE_ROCK_OUT)
                                | TUTOR(MOVE_BODY_SLAM)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_GRASS_WHISTLE)
