const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    [SPECIES_NONE] = _("??????????"),
    [SPECIES_UZUKIBASE] = _("UZUKI"),
    [SPECIES_UZUKIBLUE] = _("UZUKI"),
    [SPECIES_UZUKIGOLD] = _("UZUKI"),
    [SPECIES_UZUKIPINK] = _("UZUKI"),

    [SPECIES_RINBASE] = _("RIN"),
    [SPECIES_RINBLUE] = _("RIN"),
    [SPECIES_RINGOLD] = _("RIN"),
    [SPECIES_RINPINK] = _("RIN"),

    [SPECIES_MIOBASE] = _("MIO"),
    [SPECIES_MIOBLUE] = _("MIO"),
    [SPECIES_MIOGOLD] = _("MIO"),
    [SPECIES_MIOPINK] = _("MIO"),

    [SPECIES_MIRIABASE] = _("MIRIA"),
    [SPECIES_MIRIABLUE] = _("MIRIA"),
    [SPECIES_MIRIAGOLD] = _("MIRIA"),
    [SPECIES_MIRIAPINK] = _("MIRIA"),

    [SPECIES_KAORUBASE] = _("KAORU"),
    [SPECIES_KAORUBLUE] = _("KAORU"),
    [SPECIES_KAORUGOLD] = _("KAORU"),
    [SPECIES_KAORUPINK] = _("KAORU"),

    [SPECIES_RIINABASE] = _("RIINA"),
    [SPECIES_RIINABLUE] = _("RIINA"),
    [SPECIES_RIINAGOLD] = _("RIINA"),
    [SPECIES_RIINAPINK] = _("RIINA"),

    [SPECIES_NANAMIBASE] = _("NANAMI"),
    [SPECIES_NANAMIBLUE] = _("NANAMI"),
    [SPECIES_NANAMIGOLD] = _("NANAMI"),
    [SPECIES_NANAMIPINK] = _("NANAMI"),

    [SPECIES_ATSUMIBASE] = _("ATSUMI"),
    [SPECIES_ATSUMIBLUE] = _("ATSUMI"),
    [SPECIES_ATSUMIGOLD] = _("ATSUMI"),
    [SPECIES_ATSUMIPINK] = _("ATSUMI"),

    [SPECIES_KOZUEBASE] = _("KOZUE"),
    [SPECIES_KOZUEBLUE] = _("KOZUE"),
    [SPECIES_KOZUEGOLD] = _("KOZUE"),
    [SPECIES_KOZUEPINK] = _("KOZUE"),

    [SPECIES_NINABASE] = _("NINA"),
    [SPECIES_NINABLUE] = _("NINA"),
    [SPECIES_NINAGOLD] = _("NINA"),
    [SPECIES_NINAPINK] = _("NINA"),

    [SPECIES_SACHIKOBASE] = _("SACHIKO"),
    [SPECIES_SACHIKOBLUE] = _("SACHIKO"),
    [SPECIES_SACHIKOGOLD] = _("SACHIKO"),
    [SPECIES_SACHIKOPINK] = _("SACHIKO"),

    [SPECIES_LAYLABASE] = _("LAYLA"),
    [SPECIES_LAYLABLUE] = _("LAYLA"),
    [SPECIES_LAYLAGOLD] = _("LAYLA"),
    [SPECIES_LAYLAPINK] = _("LAYLA"),

    [SPECIES_REINABASE] = _("REINA"),
    [SPECIES_REINABLUE] = _("REINA"),
    [SPECIES_REINAGOLD] = _("REINA"),
    [SPECIES_REINAPINK] = _("REINA"),

    [SPECIES_MOMOKABASE] = _("MOMOKA"),
    [SPECIES_MOMOKABLUE] = _("MOMOKA"),
    [SPECIES_MOMOKAGOLD] = _("MOMOKA"),
    [SPECIES_MOMOKAPINK] = _("MOMOKA"),

    [SPECIES_ARISUBASE] = _("ARISU"),
    [SPECIES_ARISUBLUE] = _("ARISU"),
    [SPECIES_ARISUGOLD] = _("ARISU"),
    [SPECIES_ARISUPINK] = _("ARISU"),

    [SPECIES_AIRIBASE] = _("AIRI"),
    [SPECIES_AIRIBLUE] = _("AIRI"),
    [SPECIES_AIRIGOLD] = _("AIRI"),
    [SPECIES_AIRIPINK] = _("AIRI"),

    [SPECIES_MINAMIBASE] = _("MINAMI"),
    [SPECIES_MINAMIBLUE] = _("MINAMI"),
    [SPECIES_MINAMIGOLD] = _("MINAMI"),
    [SPECIES_MINAMIPINK] = _("MINAMI"),

    [SPECIES_ANASTASIABASE] = _("ANASTASIA"),
    [SPECIES_ANASTASIABLUE] = _("ANASTASIA"),
    [SPECIES_ANASTASIAGOLD] = _("ANASTASIA"),
    [SPECIES_ANASTASIAPINK] = _("ANASTASIA"),

    [SPECIES_HIJIRIBASE] = _("HIJIRI"),
    [SPECIES_HIJIRIBLUE] = _("HIJIRI"),
    [SPECIES_HIJIRIGOLD] = _("HIJIRI"),
    [SPECIES_HIJIRIPINK] = _("HIJIRI"),

    [SPECIES_RISABASE] = _("RISA"),
    [SPECIES_RISABLUE] = _("RISA"),
    [SPECIES_RISAGOLD] = _("RISA"),
    [SPECIES_RISAPINK] = _("RISA"),

    [SPECIES_SANABASE] = _("SANA"),
    [SPECIES_SANABLUE] = _("SANA"),
    [SPECIES_SANAGOLD] = _("SANA"),
    [SPECIES_SANAPINK] = _("SANA"),

    [SPECIES_HARUBASE] = _("HARU"),
    [SPECIES_HARUBLUE] = _("HARU"),
    [SPECIES_HARUGOLD] = _("HARU"),
    [SPECIES_HARUPINK] = _("HARU"),

    [SPECIES_MIREIBASE] = _("MIREI"),
    [SPECIES_MIREIBLUE] = _("MIREI"),
    [SPECIES_MIREIGOLD] = _("MIREI"),
    [SPECIES_MIREIPINK] = _("MIREI"),

    [SPECIES_ANZUBASE] = _("ANZU"),
    [SPECIES_ANZUBLUE] = _("ANZU"),
    [SPECIES_ANZUGOLD] = _("ANZU"),
    [SPECIES_ANZUPINK] = _("ANZU"),

    [SPECIES_KIRARIBASE] = _("KIRARI"),
    [SPECIES_KIRARIBLUE] = _("KIRARI"),
    [SPECIES_KIRARIGOLD] = _("KIRARI"),
    [SPECIES_KIRARIPINK] = _("KIRARI"),

    [SPECIES_NATALIABASE] = _("NATALIA"),
    [SPECIES_NATALIABLUE] = _("NATALIA"),
    [SPECIES_NATALIAGOLD] = _("NATALIA"),
    [SPECIES_NATALIAPINK] = _("NATALIA"),
