const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_THUNDER_PUNCH] = _("HEAVENS HAND"),
    ...
    [MOVE_THUNDER_SHOCK] = _("HEAVENSHOCK"),
    [MOVE_THUNDERBOLT] = _("HEAVENBOLT"),
    [MOVE_THUNDER_WAVE] = _("ROCK SHOCK"),
    ...
    [MOVE_SMELLING_SALT] = _("SURPRISE HIT"),
    ...
    [MOVE_DRAGON_DANCE] = _("DEVIL WALTZ"),
