...
static const u8 sNervousDescription[] = _("Moves only every two turns.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_SAND_VEIL] = _("SAND CLOAK"),
    ...
    [ABILITY_HYPER_CUTTER] = _("SHARP CLAWS"),
    [ABILITY_PICKUP] = _("PICKUP"),
    [ABILITY_NERVOUS] = _("NERVOUS"),
    ...
    [ABILITY_MOISTURIZER] = _("HYDRATION"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_NERVOUS] = sNervousDescription,
