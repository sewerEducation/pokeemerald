...
const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("IDOL BATTLE CUP");
const u8 gGiftRibbonDescriptionPart2_Participation[] = _("Participation RIBBON");
const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("IDOL LEAGUE");
const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("ADVANCE CUP");
const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("IDOL Tournament");
const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("Participation RIBBON");
const u8 gGiftRibbonDescriptionPart1_PokemonEvent[] = _("IDOL Event");
const u8 gGiftRibbonDescriptionPart1_PokemonFestival[] = _("IDOL Festival");
...
const u8 gGiftRibbonDescriptionPart1_PokemonCenterTokyo[] = _("IDOL CENTER TOKYO");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterOsaka[] = _("IDOL CENTER OSAKA");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNagoya[] = _("IDOL CENTER NAGOYA");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNY[] = _("IDOL CENTER NY");
...
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("for a loved IDOL.");
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("RIBBON that shows");
const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("love for IDOLS.");
