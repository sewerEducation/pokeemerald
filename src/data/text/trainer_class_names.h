const u8 gTrainerClassNames[][13] = {
    [TRAINER_CLASS_PKMN_TRAINER_1] = _("{PKMN} PRODUCER"),
    [TRAINER_CLASS_PKMN_TRAINER_2] = _("{PKMN} PRODUCER"),
    [TRAINER_CLASS_HIKER] = _("HIKER"),
    [TRAINER_CLASS_TEAM_AQUA] = _("AQUA GRUNT"),
    [TRAINER_CLASS_PKMN_BREEDER] = _("STAGEHAND"),
    [TRAINER_CLASS_COOLPRODUCER] = _("IDOL PRO"),
    [TRAINER_CLASS_BIRD_KEEPER] = _("NORMAL GUY"),
    [TRAINER_CLASS_COLLECTOR] = _("IDOL MANIAC"),
    [TRAINER_CLASS_SWIMMER_M] = _("SWIMMER"),
    [TRAINER_CLASS_TEAM_MAGMA] = _("MAGMA GRUNT"),
    ...
    [TRAINER_CLASS_POKEMANIAC] = _("IDOL MANIAC"),
    [TRAINER_CLASS_GUITARIST] = _("GUITARIST"),
    [TRAINER_CLASS_KINDLER] = _("KINDLER"),
    [TRAINER_CLASS_CAMPER] = _("JR PRODUCER"),
    [TRAINER_CLASS_PICNICKER] = _("JR PRODUCER"),
    ...
    [TRAINER_CLASS_SR_AND_JR] = _("CLASSMATES"),
    [TRAINER_CLASS_WINSTRATE] = _("WINSTRATE"),
    [TRAINER_CLASS_POKEFAN] = _("IDOL FAN"),
    ...
    [TRAINER_CLASS_DRAGON_TAMER] = _("ABNORMAL GUY"),
    ...
    [TRAINER_CLASS_COOLTRAINER_2] = _("IDOL PRO"),
    [TRAINER_CLASS_MAGMA_ADMIN] = _("MAGMA ADMIN"),
    [TRAINER_CLASS_RIVAL] = _("{PKMN} PRODUCER"),
    [TRAINER_CLASS_BUG_CATCHER] = _("BUG CATCHER"),
    [TRAINER_CLASS_PKMN_RANGER] = _("SECURITY"),
    ...
    [TRAINER_CLASS_RS_PROTAG] = _("{PKMN} PRODUCER"),
};
