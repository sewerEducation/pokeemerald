...
static const u8 sWithdrawDescription[] = _(
    "Withdraws the body into a\n"
    "hiding spot to raise DEFENSE.");
...
static const u8 sPoisonGasDescription[] = _(
    "Emit a foul stench that\n"
    "makes normal moves toxic.");
...
static const u8 sDrainKissDescription[] = _(
    "Kisses the foe with such\n"
    "force that it steals health.");
...
static const u8 sSweetScentDescription[] = _(
    "Emit a sweet aroma that\n"
    "makes normal moves sweet.");

static const u8 sIronTailDescription[] = _(
    "Attacks with a rock-hard\n"
    "body. May lower DEFENSE.");
...
static const u8 sVitalThrowDescription[] = _(
    "Press body against foe's.\n"
    "Does DEFENSE based damage.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_BUG_BUZZ - 1] = sCometPunchDescription,
    ...
    [MOVE_PINCH - 1] = sViceGripDescription,
    ...
    [MOVE_FLASHY_KICK - 1] = sRollingKickDescription,
    ...
    [MOVE_HEAD_SMASH - 1] = sHornDrillDescription,
    ...
    [MOVE_SNEAKY_NEEDLE - 1] = sTwineedleDescription,
    ...
    [MOVE_TINY_TANTRUM - 1] = sRageDescription,
    ...
    [MOVE_SPEED_STAR - 1] = sSwiftDescription,
    ...
    [MOVE_FOUL_SCENT - 1] = sPoisonGasDescription,
    ...
    [MOVE_SWEET_TALK - 1] = sSparkDescription,
    ...
    [MOVE_HALLOWEEN - 1] = sDynamicPunchDescription,
    ...
    [MOVE_BODY_PRESS - 1] = sVitalThrowDescription,
    ...
    [MOVE_TRENDSETTER - 1] = sExtremeSpeedDescription,
    ...
    [MOVE_PLANETFALL - 1] = sSuperpowerDescription,
    ...
    [MOVE_DAZZLING - 1] = sVoltTackleDescription,
