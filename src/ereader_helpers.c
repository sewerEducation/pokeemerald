...
static const struct TrainerHillTrainer sTrainerHillTrainerTemplates_JP[] = {
    [0] = {
        ...
        .mons = {
            ...
            [4] = {
                ...
                .moves = { MOVE_STARDUST, MOVE_SLUDGE_BOMB, MOVE_SHADOW_BALL, MOVE_GIGA_DRAIN },
                .hpEV = 0,
                .attackEV = 255,
                .defenseEV = 0,
                .speedEV = 0,
    ...
    [1] = {
        ...
        .speechWin = { EC_MOVE(ACID), EC_WORD_AS_MUCH_AS, EC_EMPTY_WORD, EC_WORD_THEY_RE, EC_WORD_HAPPY, EC_WORD_EXCL },
        ...
        .mons = {
            ...
            [3] = {
                ...
                .heldItem = ITEM_QUICK_CLAW,
                .moves = { MOVE_GIGA_DRAIN, MOVE_FEINT_ATTACK, MOVE_HEAVEN_PUNCH, MOVE_GROWTH },
                .hpEV = 55,
                .attackEV = 0,
                .defenseEV = 100,
                .speedEV = 0,
    ...
    [2] = {
        ...
        .mons = {
            ...
            [3] = {
                ...
                .moves = { MOVE_SING, MOVE_BODY_SLAM, MOVE_SHADOW_BALL, MOVE_IRON_TACKLE },
                .hpEV = 0,
                .attackEV = 255,
                .defenseEV = 0,
                .speedEV = 255,
            ...
            [5] = {
                ...
                .heldItem = ITEM_BRIGHT_POWDER,
                .moves = { MOVE_STARDUST, MOVE_AERIAL_ACE, MOVE_ATTRACT, MOVE_PSYCHIC },
                .hpEV = 100,
                .attackEV = 200,
                .defenseEV = 0,
                .speedEV = 0,
    ...
    [3] = {
        ...
        .mons = {
            ...
            [3] = {
                ...
                .heldItem = ITEM_BRIGHT_POWDER,
                .moves = { MOVE_VAMPIRE, MOVE_FLAMETHROWER, MOVE_HEAVEN_PUNCH, MOVE_BUG_BUZZ },
                .hpEV = 0,
                .attackEV = 0,
                .defenseEV = 100,
                .speedEV = 0,
            ...
            [4] = {
                ...
                .moves = { MOVE_SURF, MOVE_VAMPIRE, MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE },
                .hpEV = 255,
                .attackEV = 0,
                .defenseEV = 0,
                .speedEV = 0,
            ...
            [5] = {
                ...
                .heldItem = ITEM_LUM_BERRY,
                .moves = { MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_HEAVENBOLT, MOVE_WILL_O_WISP },
                .hpEV = 255,
                .attackEV = 0,
                .defenseEV = 0,
                .speedEV = 0,
