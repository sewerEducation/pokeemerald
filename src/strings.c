...
const u8 gText_Pokedex[] = _("IDOLDEX"); // Unused
...
const u8 gText_ThisIsAPokemon[] = _("This is what we call an “IDOL.”{PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? IDOL");
const u8 gText_UnkHeight[] = _("??? cm");
const u8 gText_UnkWeight[] = _(" ?? kg");
const u8 gText_EmptyPkmnCategory[] = _("                       IDOL"); // Unused
...
const u8 gText_PokedexRegistration[] = _("IDOLDEX registration completed.");
...
const u8 gText_NoMatchingPkmnWereFound[] = _("No matching IDOLS were found.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for IDOLS based on\nselected parameters.");
const u8 gText_SwitchPokedexListings[] = _("Switch IDOLDEX listings.");
const u8 gText_ReturnToPokedex[] = _("Return to the IDOLDEX.");
const u8 gText_SelectPokedexMode[] = _("Select the IDOLDEX mode.");
const u8 gText_SelectPokedexListingMode[] = _("Select the IDOLDEX listing mode.");
const u8 gText_ListByFirstLetter[] = _("List by the first letter in the name.\nSpotted IDOLS only.");
const u8 gText_ListByBodyColor[] = _("List by color.\nSpotted IDOLS only.");
...
const u8 gText_DexHoennDescription[] = _("HOENN region's IDOLDEX");
const u8 gText_DexNatDescription[] = _("National edition IDOLDEX");
const u8 gText_DexSortNumericalDescription[] = _("IDOLS are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and scouted IDOLS are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Scouted IDOLS are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Scouted IDOLS are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Scouted IDOLS are listed from the\ntallest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Scouted IDOLS are listed from the\nsmallest to the tallest.");
...
const u8 gText_HOFDexRating[] = _("Spotted IDOLS: {STR_VAR_1}!\nScouted IDOLS: {STR_VAR_2}!\pPROF. BIRCH's IDOLDEX rating!\pPROF. BIRCH: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("PROF. BIRCH is in trouble!\nRelease an IDOL and rescue him!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this IDOL?");
const u8 gText_Pokemon4[] = _("IDOLS"); // Unused
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild IDOLS will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild IDOLS will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThePokemonList[] = _("the IDOL LIST");
...
const u8 gText_PokeBallsPocket[] = _("TICKETS");
const u8 gText_TMHMPocket[] = _("TMs & HMs");
const u8 gText_BerriesPocket[] = _("SNACKS");
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} IDOL\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon2[] = _("Teach which IDOL?"); // Unused
const u8 gText_ChoosePokemon[] = _("Choose an IDOL.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which IDOL?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which IDOL?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which IDOL?");
...
const u8 gText_NoPokemonForBattle[] = _("No IDOL for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose an IDOL.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} IDOLS are needed.");
const u8 gText_PokemonCantBeSame[] = _("IDOLS can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose IDOLS or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose IDOLS and confirm.");
...
const u8 gText_PkmnCantParticipate[] = _("That IDOL can't participate.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That IDOL can't be traded\nnow.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other PRODUCER's IDOL\ncan't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainerCantAcceptPkmn[] = _("The other PRODUCER can't accept\nthat IDOL now.");
ALIGNED(4) const u8 gText_CantTradeWithTrainer[] = _("You can't trade with that\nPRODUCER now.");
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of IDOL\nthat the other PRODUCER wants.");
...
const u8 gText_OTSlash[] = _("OP/");
const u8 gText_RentalPkmn[] = _("RENTAL IDOL");
...
const u8 gText_PkmnInfo[] = _("IDOL INFO");
const u8 gText_PkmnSkills[] = _("IDOL SKILLS");
const u8 gText_BattleMoves[] = _("LIVE MOVES");
...
const u8 gText_XNatureCinLevU255[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} focused\nCINDERELLA Level: {DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}%");
const u8 gText_XNatureCinLevMax[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} focused\nCINDERELLA Level: {DYNAMIC 0}MAX{DYNAMIC 1}");
const u8 gText_XNatureTradeU255[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} focused\nCINDERELLA Level: {DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}%\noriginally from another studio");
const u8 gText_XNatureTradeMax[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} focused\nCINDERELLA Level: {DYNAMIC 0}MAX{DYNAMIC 1}%\noriginally from another studio");
...
const u8 gText_XNature[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} focused\nCINDERELLA Level: {DYNAMIC 0}???{DYNAMIC 1}%\nFrom a rental studio");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd EGG found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar EGG\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar EGG\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("An EGG obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd EGG\nobtained from a traveler.");
...
const u8 gText_MenuOptionPokedex[] = _("IDOLDEX");
const u8 gText_MenuOptionPokemon[] = _("IDOLS");
const u8 gText_MenuOptionBag[] = _("BAG");
const u8 gText_MenuOptionPokenav[] = _("IDOLNAV");
...
const u8 gText_PokemonJump[] = _("IDOL JUMP");
...
const u8 gText_PokemonNature[] = _("IDOL FOCUS");
const u8 gText_PokemonMoves[] = _("IDOL MOVES");
const u8 gText_Underpowered[] = _("UNDERPOWERED");
const u8 gText_WhenInDanger[] = _("WHEN IN DANGER");
const u8 gText_PyramidPokemon[] = _("PYRAMID: IDOLS");
const u8 gText_PyramidTrainers[] = _("PYRAMID: PRODUCERS");
const u8 gText_PyramidMaze[] = _("PYRAMID: MAZE");
const u8 gText_BattleBag2[] = _("BATTLE BAG");
const u8 gText_PokenavAndBag[] = _("IDOLNAV AND BAG");
const u8 gText_HeldItems[] = _("HELD ITEMS");
const u8 gText_PokemonOrder[] = _("IDOL ORDER");
const u8 gText_BattlePokemon[] = _("BATTLE IDOLS");
const u8 gText_BattleTrainers[] = _("BATTLE PRODUCERS");
...
const u8 gText_LilycoveCity[] = _("IDOL HILL");
const u8 gText_SlateportCity[] = _("IDOL PARK");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this IDOL?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0}!");
const u8 gText_MarkYourPkmn[] = _("Mark your IDOL.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last IDOL!");
const u8 gText_YourPartysFull[] = _("Your unit's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding an IDOL!");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to an IDOL?");
...
const u8 gPCText_Pokecenter[] = _("PLUS");
...
const u8 gText_WithdrawPokemon[] = _("WITHDRAW IDOLS");
const u8 gText_DepositPokemon[] = _("DEPOSIT IDOLS");
const u8 gText_MovePokemon[] = _("MOVE IDOLS");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("Move IDOLS stored in BOXES to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store IDOLS in your party in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organize the IDOLS in BOXES and\nin your party.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any IDOLS\nin a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("Return to the previous menu.");
const u8 gText_JustOnePkmn[] = _("There is just one IDOL with you.");
...
const u8 gText_CheckPokemonInDetail[] = _("Check IDOL in detail.");
const u8 gText_CallRegisteredTrainer[] = _("Call a registered PRODUCER.");
const u8 gText_CheckObtainedRibbons[] = _("Check obtained RIBBONS.");
const u8 gText_PutAwayPokenav[] = _("Put away the IDOLNAV.");
const u8 gText_NoRibbonWinners[] = _("There are no RIBBON winners.");
const u8 gText_NoTrainersRegistered[] = _("No PRODUCERS are registered."); // Unused
const u8 gText_CheckPartyPokemonInDetail[] = _("Check party IDOLS in detail.");
const u8 gText_CheckAllPokemonInDetail[] = _("Check all IDOLS in detail.");
const u8 gText_ReturnToPokenavMenu[] = _("Return to the IDOLNAV menu.");
const u8 gText_FindCoolPokemon[] = _("Find cool IDOLS.");
const u8 gText_FindBeautifulPokemon[] = _("Find beautiful IDOLS.");
const u8 gText_FindCutePokemon[] = _("Find cute IDOLS.");
const u8 gText_FindSmartPokemon[] = _("Find smart IDOLS.");
const u8 gText_FindToughPokemon[] = _("Find tough IDOLS.");
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("PRODUCER'S IDOLS");
...
const u8 gText_TrainerCloseBy[] = _("That PRODUCER is close by.\nTalk to the PRODUCER in person!");
...
const u8 gText_TheTrainersImage[] = _("the PRODUCER's image.");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the IDOL MAIL?");
...
const u8 gText_StopGivingPkmnMail2[] = _("Stop giving the IDOL MAIL?"); // Unused
...
const u8 gText_PokemonLeague[] = _("IDOL LEAGUE");
const u8 gText_PokemonCenter[] = _("IDOL CENTER");
...
const u8 gText_AncientBugBP[] = _("ANCIENT BUG{CLEAR_TO 0x5E}4BP");
const u8 gText_LightBallBP[] = _("LIGHT BALL{CLEAR_TO 0x5E}4BP");
const u8 gText_WildClubBP[] = _("WILD CLUB{CLEAR_TO 0x5E}4BP");
const u8 gText_StrangeUFOBP[] = _("STRANGE UFO{CLEAR_TO 0x5E}4BP");
const u8 gText_MiracleSeedBP[] = _("MIRACLE SEED{CLEAR_TO 0x5E}4BP");
const u8 gText_BlackGlassesBP[] = _("ROCKINSHADES{CLEAR_TO 0x5E}4BP");
const u8 gText_BlackBeltBP[] = _("BLACK BELT{CLEAR_TO 0x5E}4BP");
const u8 gText_MagnetBP[] = _("MAGNET{CLEAR_TO 0x5E}4BP");
const u8 gText_MysticWaterBP[] = _("MYSTIC WATER{CLEAR_TO 0x5E}4BP");
const u8 gText_AcrylicNailBP[] = _("ACRYLIC NAIL{CLEAR_TO 0x5E}4BP");
const u8 gText_PoisonBarbBP[] = _("POISON BARB{CLEAR_TO 0x5E}4BP");
const u8 gText_NeverMeltIceBP[] = _("NEVERMELTICE{CLEAR_TO 0x5E}4BP");
const u8 gText_SpellTagBP[] = _("SPELL TAG{CLEAR_TO 0x5E}4BP");
const u8 gText_TwistedSpoonBP[] = _("TWISTEDSPOON{CLEAR_TO 0x5E}4BP");
const u8 gText_CharcoalBP[] = _("CHARCOAL{CLEAR_TO 0x5E}4BP");
const u8 gText_DevilToothBP[] = _("DEVIL TOOTH{CLEAR_TO 0x5E}4BP");
const u8 gText_SilkScarfBP[] = _("SILK SCARF{CLEAR_TO 0x5E}4BP");
const u8 gText_CandyPouchBP[] = _("CANDY POUCH{CLEAR_TO 0x5E}4BP");
const u8 gText_PinkSlipperBP[] = _("PINK SLIPPER{CLEAR_TO 0x58}6BP");
const u8 gText_GoldSlipperBP[] = _("GOLD SLIPPER{CLEAR_TO 0x58}6BP");
const u8 gText_BlueSlipperBP[] = _("BLUE SLIPPER{CLEAR_TO 0x58}6BP");
const u8 gText_NuggetBP[] = _("NUGGET{CLEAR_TO 0x58}1BP");
const u8 gText_AbilitySwapBP[] = _("ABILITYJUICE{CLEAR_TO 0x58}8BP");
...
const u8 gText_Leftovers48BP[] = _("LEFTOVERS{CLEAR_TO 0x5E}4BP");
const u8 gText_WhiteHerb48BP[] = _("WHITE HERB{CLEAR_TO 0x5E}4BP");
const u8 gText_QuickClaw48BP[] = _("QUICK CLAW{CLEAR_TO 0x5E}4BP");
const u8 gText_MentalHerb48BP[] = _("MENTAL HERB{CLEAR_TO 0x5E}4BP");
const u8 gText_ShellBell64BP[] = _("SHELL BELL{CLEAR_TO 0x5E}8BP");
const u8 gText_ChoiceBand64BP[] = _("CHOICE BAND{CLEAR_TO 0x5E}8BP");
const u8 gText_KingsRock64BP[] = _("KING'S ROCK{CLEAR_TO 0x5E}8BP");
const u8 gText_FocusBand64BP[] = _("FOCUS BAND{CLEAR_TO 0x5E}8BP");
const u8 gText_ScopeLens64BP[] = _("SCOPE LENS{CLEAR_TO 0x5E}8BP");
const u8 gText_Softboiled16BP[] = _("BUG BUZZ{CLEAR_TO 0x4E}1BP");
const u8 gText_SeismicToss24BP[] = _("PSYCH UP{CLEAR_TO 0x4E}1BP");
const u8 gText_DreamEater24BP[] = _("MIMIC{CLEAR_TO 0x4E}1BP");
const u8 gText_MegaPunch24BP[] = _("SEISMIC TOSS{CLEAR_TO 0x4E}1BP");
const u8 gText_MegaKick48BP[] = _("ROCK OUT{CLEAR_TO 0x4E}1BP");
const u8 gText_BodySlam48BP[] = _("SWAGGER{CLEAR_TO 0x4E}1BP");
const u8 gText_RockSlide48BP[] = _("TEETER DANCE{CLEAR_TO 0x4E}1BP");
const u8 gText_Counter48BP[] = _("SWORDS DANCE{CLEAR_TO 0x4E}2BP");
const u8 gText_ThunderWave48BP[] = _("HI JUMP KICK{CLEAR_TO 0x4E}2BP");
const u8 gText_SwordsDance48BP[] = _("EXPLOSION{CLEAR_TO 0x4E}2BP");
const u8 gText_DefenseCurl16BP[] = _("SING{CLEAR_TO 0x4E}1BP");
const u8 gText_Snore24BP[] = _("ENDURE{CLEAR_TO 0x4E}1BP");
const u8 gText_MudSlap24BP[] = _("ROLE PLAY{CLEAR_TO 0x4E}1BP");
const u8 gText_Swift24BP[] = _("FIRE SPIN{CLEAR_TO 0x4E}1BP");
const u8 gText_IcyWind24BP[] = _("SUBSTITUTE{CLEAR_TO 0x4E}1BP");
const u8 gText_Endure48BP[] = _("FLATTER{CLEAR_TO 0x4E}1BP");
const u8 gText_PsychUp48BP[] = _("FEATHERDANCE{CLEAR_TO 0x4E}1BP");
const u8 gText_IcePunch48BP[] = _("DEVIL WALTZ{CLEAR_TO 0x4E}2BP");
const u8 gText_ThunderPunch48BP[] = _("DOUBLE-EDGE{CLEAR_TO 0x4E}2BP");
const u8 gText_FirePunch48BP[] = _("PETAL DANCE{CLEAR_TO 0x4E}2BP");
...
const u8 gText_TrainerCardPokedex[] = _("IDOLDEX");
...
const u8 gText_Var1sTrainerCard[] = _("{STR_VAR_1}'s PRODUCER CARD");
...
const u8 gText_PokemonTrades[] = _("IDOL TRADES");
const u8 gText_UnionTradesAndBattles[] = _("UNION TRADES & BATTLES");
const u8 gText_BerryCrush[] = _("BERRY CRUSH");
const u8 gText_WaitingTrainerFinishReading[] = _("Waiting for the other PRODUCER to\nfinish reading your PRODUCER CARD.");
...
const u8 gText_Pokemon2[] = _("IDOLS");
...
const u8 gText_MatchCallSteven_Pokemon[] = _("Ultimate STEEL IDOL.");
...
const u8 gText_MatchCallBrendan_Pokemon[] = _("I will use various IDOLS.");
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better IDOL");
...
const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any IDOL!");
const u8 gText_MatchCallMay_Intro1[] = _("My IDOLS and I help");
...
const u8 gText_CheckTrainerCard[] = _("Check PRODUCER CARD.");
...
const u8 gText_BattlePalaceDesc[] = _("Watch your IDOLS battle!\nYour spirit will be tested.");
const u8 gText_BattleArenaDesc[] = _("Win battles with teamed-up IDOLS!\nYour guts will be tested.");
const u8 gText_BattleFactoryDesc[] = _("Aim for victory using rental IDOLS!\nYour knowledge will be tested.");
...
const u8 gText_ContinueMenuPokedex[] = _("IDOLDEX");
...
const u8 gText_PkmnJumpRecords[] = _("IDOL JUMP RECORDS");
...
const u8 gText_MenuPokedex[] = _("IDOLDEX");
const u8 gText_MenuPokemon[] = _("IDOLS");
const u8 gText_MenuBag[] = _("BAG");
const u8 gText_MenuPokenav[] = _("IDOLNAV");
...
const u8 gText_SafariBallStock[] = _("SCOUT TICKETS\nStock: {STR_VAR_1}");
...
const u8 gText_PokemonOnHook[] = _("An IDOL's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("IDOLS");
const u8 gEasyChatGroupName_Trainer[] = _("PRODUCER");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("IDOL2");
...
const u8 gText_RentalPkmn2[] = _("RENTAL IDOLS");
const u8 gText_SelectFirstPkmn[] = _("Select the first IDOL.");
const u8 gText_SelectSecondPkmn[] = _("Select the second IDOL.");
const u8 gText_SelectThirdPkmn[] = _("Select the third IDOL.");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three IDOLS OK?");
const u8 gText_Yes2[] = _("YES");
const u8 gText_No2[] = _("NO");
const u8 gText_CantSelectSamePkmn[] = _("Can't select same {PKMN}.");
const u8 gText_PkmnSwap[] = _("IDOL SWAP");
const u8 gText_SelectPkmnToSwap[] = _("Select IDOL to swap.");
const u8 gText_SelectPkmnToAccept[] = _("Select IDOL to accept.");
...
const u8 gText_AcceptThisPkmn[] = _("Accept this IDOL?");
...
const u8 gText_SavingPokedex[] = _("IDOLDEX");
...
ALIGNED(4) const u8 gText_NewTrainerReceived[] = _("A new PRODUCER has arrived.");
...
ALIGNED(4) const u8 gText_OtherTrainerHasCard[] = _("The other PRODUCER has the same\nWONDER CARD already.");
ALIGNED(4) const u8 gText_OtherTrainerHasNews[] = _("The other PRODUCER has the same\nWONDER NEWS already.");
ALIGNED(4) const u8 gText_OtherTrainerHasStamp[] = _("The other PRODUCER has the same\nSTAMP already.");
ALIGNED(4) const u8 gText_OtherTrainerCanceled[] = _("The other PRODUCER canceled\ncommunication.");
