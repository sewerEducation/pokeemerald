...
const u8 gText_Pokemon[] = _("IDOLS");
...
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “IDOLS.”{PAUSE 96}\p");
...
const u8 gText_HOFDexRating[] = _("Spotted IDOLS: {STR_VAR_1}!\nScouted IDOLS: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see…\p");
