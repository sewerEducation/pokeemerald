...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_HARUBASE] = gMonIcon_HaruBase,
    [SPECIES_HARUBLUE] = gMonIcon_HaruBlue,
    [SPECIES_HARUGOLD] = gMonIcon_HaruGold,
    [SPECIES_HARUPINK] = gMonIcon_HaruPink,
    [SPECIES_MIREIBASE] = gMonIcon_MireiBase,
    [SPECIES_MIREIBLUE] = gMonIcon_MireiBlue,
    [SPECIES_MIREIGOLD] = gMonIcon_MireiGold,
    [SPECIES_MIREIPINK] = gMonIcon_MireiPink,
    [SPECIES_ANZUBASE] = gMonIcon_AnzuBase,
    [SPECIES_ANZUBLUE] = gMonIcon_AnzuBlue,
    [SPECIES_ANZUGOLD] = gMonIcon_AnzuGold,
    [SPECIES_ANZUPINK] = gMonIcon_AnzuPink,
    [SPECIES_KIRARIBASE] = gMonIcon_KirariBase,
    [SPECIES_KIRARIBLUE] = gMonIcon_KirariBlue,
    [SPECIES_KIRARIGOLD] = gMonIcon_KirariGold,
    [SPECIES_KIRARIPINK] = gMonIcon_KirariPink,
    [SPECIES_NATALIABASE] = gMonIcon_NataliaBase,
    [SPECIES_NATALIABLUE] = gMonIcon_NataliaBlue,
    [SPECIES_NATALIAGOLD] = gMonIcon_NataliaGold,
    [SPECIES_NATALIAPINK] = gMonIcon_NataliaPink,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_ANZUGOLD] = 0,
    [SPECIES_ANZUPINK] = 0,
    [SPECIES_KIRARIBASE] = 0,
    [SPECIES_KIRARIBLUE] = 0,
    [SPECIES_KIRARIGOLD] = 0,
    [SPECIES_KIRARIPINK] = 0,
    [SPECIES_NATALIABASE] = 0,
    [SPECIES_NATALIABLUE] = 0,
    [SPECIES_NATALIAGOLD] = 0,
    [SPECIES_NATALIAPINK] = 0,
    [SPECIES_MAROWAK] = 0,
    [SPECIES_HITMONLEE] = 0,
