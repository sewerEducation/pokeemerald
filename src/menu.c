...
{   // { width, height, offset }
    ...
    [TYPE_SPORTS + 1]   = { 32, 12, 0x64 },
    [TYPE_GAL + 1]      = { 32, 12, 0x60 },
    [TYPE_TOXIC + 1]    = { 32, 12, 0x80 },
    [TYPE_ROCK + 1]     = { 32, 12, 0x48 },
    [TYPE_WILD + 1]     = { 32, 12, 0x44 },
    [TYPE_BUG + 1]      = { 32, 12, 0x6C },
    [TYPE_DEVIL + 1]    = { 32, 12, 0x68 },
    [TYPE_METAL + 1]    = { 32, 12, 0x88 },
    [TYPE_SWEET + 1]    = { 32, 12, 0xA4 },
    [TYPE_HOT + 1]      = { 32, 12, 0x24 },
    [TYPE_OCEAN + 1]    = { 32, 12, 0x28 },
    [TYPE_NATURE + 1]   = { 32, 12, 0x2C },
    [TYPE_ANGEL + 1]    = { 32, 12, 0x40 },
    [TYPE_ESPER + 1]    = { 32, 12, 0x84 },
    [TYPE_COLD + 1]     = { 32, 12, 0x4C },
    [TYPE_GHOST + 1]    = { 32, 12, 0xA0 },
    [TYPE_COSMIC + 1]   = { 32, 12, 0x8C },
