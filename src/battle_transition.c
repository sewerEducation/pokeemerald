...
{
    [MUGSHOT_SIDNEY]   = PRODUCER_PIC_ELITE_FOUR_SIDNEY,
    [MUGSHOT_PHOEBE]   = PRODUCER_PIC_ELITE_FOUR_PHOEBE,
    [MUGSHOT_GLACIA]   = PRODUCER_PIC_ELITE_FOUR_GLACIA,
    [MUGSHOT_DRAKE]    = PRODUCER_PIC_ELITE_FOUR_DRAKE,
    [MUGSHOT_CHAMPION] = PRODUCER_PIC_CHAMPION_WALLACE,
};
