...
const u8 gTypeEffectiveness[387] =
{
    TYPE_NORMAL, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NORMAL, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SPORTS, TYPE_NORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SPORTS, TYPE_TOXIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SPORTS, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SPORTS, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SPORTS, TYPE_METAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SPORTS, TYPE_ESPER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SPORTS, TYPE_COLD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAL, TYPE_TOXIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAL, TYPE_WILD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAL, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAL, TYPE_ANGEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAL, TYPE_ESPER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAL, TYPE_DEVIL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAL, TYPE_GAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_TOXIC, TYPE_TOXIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_TOXIC, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_TOXIC, TYPE_GHOST, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_TOXIC, TYPE_METAL, TYPE_MUL_NO_EFFECT,
    TYPE_TOXIC, TYPE_OCEAN, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_TOXIC, TYPE_NATURE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_TOXIC, TYPE_GAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_TOXIC, TYPE_SWEET, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ROCK, TYPE_SPORTS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ROCK, TYPE_COSMIC, TYPE_MUL_NO_EFFECT,
    TYPE_ROCK, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ROCK, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ROCK, TYPE_HOT, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ROCK, TYPE_ANGEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ROCK, TYPE_COLD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WILD, TYPE_SPORTS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WILD, TYPE_TOXIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WILD, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WILD, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WILD, TYPE_NATURE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WILD, TYPE_ANGEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WILD, TYPE_ESPER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WILD, TYPE_DEVIL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WILD, TYPE_GAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WILD, TYPE_SWEET, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BUG, TYPE_SPORTS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_HOT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_NATURE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BUG, TYPE_ESPER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BUG, TYPE_DEVIL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_GAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BUG, TYPE_SWEET, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DEVIL, TYPE_SPORTS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DEVIL, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DEVIL, TYPE_ANGEL, TYPE_MUL_NO_EFFECT,
    TYPE_DEVIL, TYPE_DEVIL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DEVIL, TYPE_SWEET, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_METAL, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_METAL, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_METAL, TYPE_HOT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_METAL, TYPE_ANGEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_METAL, TYPE_COLD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_METAL, TYPE_SWEET, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_HOT, TYPE_WILD, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_HOT, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_HOT, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_HOT, TYPE_METAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_HOT, TYPE_HOT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_HOT, TYPE_OCEAN, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_HOT, TYPE_NATURE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_HOT, TYPE_COLD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_HOT, TYPE_SWEET, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_OCEAN, TYPE_WILD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_OCEAN, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_OCEAN, TYPE_HOT, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_OCEAN, TYPE_OCEAN, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_OCEAN, TYPE_NATURE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_OCEAN, TYPE_DEVIL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NATURE, TYPE_COSMIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NATURE, TYPE_TOXIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NATURE, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NATURE, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NATURE, TYPE_METAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NATURE, TYPE_HOT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NATURE, TYPE_OCEAN, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NATURE, TYPE_NATURE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NATURE, TYPE_ANGEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ANGEL, TYPE_COSMIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ANGEL, TYPE_TOXIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ANGEL, TYPE_WILD, TYPE_MUL_NO_EFFECT,
    TYPE_ANGEL, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ANGEL, TYPE_OCEAN, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ANGEL, TYPE_NATURE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ANGEL, TYPE_ANGEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ANGEL, TYPE_DEVIL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ESPER, TYPE_SPORTS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ESPER, TYPE_COSMIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ESPER, TYPE_TOXIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ESPER, TYPE_ESPER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ESPER, TYPE_GAL, TYPE_MUL_NO_EFFECT,
    TYPE_COLD, TYPE_COSMIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_COLD, TYPE_WILD, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_COLD, TYPE_HOT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_COLD, TYPE_NATURE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_COLD, TYPE_COLD, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_COLD, TYPE_GAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_COLD, TYPE_SWEET, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_NORMAL, TYPE_MUL_NO_EFFECT,
    TYPE_GHOST, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GHOST, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_ESPER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_DEVIL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GHOST, TYPE_GAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_COSMIC, TYPE_COSMIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_COSMIC, TYPE_WILD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_COSMIC, TYPE_NATURE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_COSMIC, TYPE_ANGEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_COSMIC, TYPE_ESPER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_COSMIC, TYPE_COLD, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_COSMIC, TYPE_DEVIL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SWEET, TYPE_SPORTS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SWEET, TYPE_TOXIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SWEET, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SWEET, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SWEET, TYPE_HOT, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SWEET, TYPE_COLD, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SWEET, TYPE_DEVIL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SWEET, TYPE_SWEET, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FORESIGHT, TYPE_FORESIGHT, TYPE_MUL_NO_EFFECT,
    TYPE_NORMAL, TYPE_GHOST, TYPE_MUL_NO_EFFECT,
    TYPE_SPORTS, TYPE_GHOST, TYPE_MUL_NO_EFFECT,
...
u8 IsRunningFromBattleImpossible(void)
{
    ...
    for (i = 0; i < gBattlersCount; i++)
    {
        ...
        if (side != GetBattlerSide(i)
         ...
         && !IS_BATTLER_OF_TYPE(gActiveBattler, TYPE_COSMIC)
            ...
            if (!(gBattleControllerExecFlags & ((gBitTable[gActiveBattler]) | (0xF << 28) | (gBitTable[gActiveBattler] << 4) | (gBitTable[gActiveBattler] << 8) | (gBitTable[gActiveBattler] << 12))))
            {
                ...
                case B_ACTION_SWITCH:
                    *(gBattleStruct->battlerPartyIndexes + gActiveBattler) = gBattlerPartyIndexes[gActiveBattler];
                    if ((gBattleMons[gActiveBattler].status2 & (STATUS2_WRAPPED | STATUS2_ESCAPE_PREVENTION) && gBattleMons[gActiveBattler].ability != ABILITY_RUN_AWAY)
