...
static const u16 sMoves_TotalPreparation[] =
{
    ...
    MOVE_CHARGE, MOVE_SNATCH, MOVE_STAR_GLOW, MOVE_COSMIC_POWER, MOVE_IRON_DEFENSE, MOVE_HOWL, MOVE_BULK_UP, MOVE_CALM_MIND, MOVE_DRAGON_DANCE,
    MOVE_NONE
};
...
static const u16 sMoves_SlowAndSteady[] =
{
    ...
    MOVE_THUNDER_WAVE, MOVE_TOXIC, MOVE_HYPNOSIS, MOVE_CONFUSE_RAY, MOVE_GLARE, MOVE_POISON_GAS, MOVE_DRAIN_KISS, MOVE_SPORE,
