...
static const u16 sMoves_TotalPreparation[] =
{
    ...
    MOVE_CHARGE, MOVE_SNATCH, MOVE_STAR_GLOW, MOVE_COSMIC_POWER, MOVE_IRON_DEFENSE, MOVE_HOWL, MOVE_BULK_UP, MOVE_CALM_MIND, MOVE_DEVIL_WALTZ,
    MOVE_NONE
};

static const u16 sMoves_ImpossibleToPredict[] =
{
    MOVE_MIMIC, MOVE_METRONOME, MOVE_COPYCAT, MOVE_TRANSFORM, MOVE_SUBSTITUTE, MOVE_SKETCH, MOVE_CURSE,
...
{
    MOVE_SAND_ATTACK, MOVE_TAIL_WAG, MOVE_LEER, MOVE_GROWL, MOVE_STRING_SHOT, MOVE_SCREECH, MOVE_SMOKESCREEN, MOVE_KINESIS,
...
{
    MOVE_GUILLOTINE, MOVE_HEAD_SMASH, MOVE_DOUBLE_EDGE, MOVE_HYPER_BEAM, MOVE_COUNTER, MOVE_FISSURE,
    MOVE_BIDE, MOVE_SELF_DESTRUCT, MOVE_SKY_ATTACK, MOVE_EXPLOSION, MOVE_FLAIL, MOVE_REVERSAL, MOVE_DESTINY_BOND,
    MOVE_PERISH_SONG, MOVE_PAIN_SPLIT, MOVE_MIRROR_COAT, MOVE_MEMENTO, MOVE_GRUDGE, MOVE_FACADE, MOVE_FOCUS_BLAST,
    MOVE_BLAST_BURN, MOVE_HYDRO_CANNON, MOVE_OVERHEAT, MOVE_FRENZY_PLANT, MOVE_PSYCHO_BOOST, MOVE_DAZZLING,
    MOVE_NONE
};
...
static const u16 sMoves_SlowAndSteady[] =
{
    ...
    MOVE_ROCK_SHOCK, MOVE_TOXIC, MOVE_HYPNOSIS, MOVE_CONFUSE_RAY, MOVE_GLARE, MOVE_FOUL_SCENT, MOVE_DRAIN_KISS, MOVE_SPORE,
...
{
    // Level 50
    {FRONTIER_MON_HARUPINK,     FRONTIER_MON_FURRET_1},   // 110 - 199
    {FRONTIER_MON_DELCATTY_1, FRONTIER_MON_MIREIGOLD_1}, // 162 - 266
    {FRONTIER_MON_DELCATTY_2, FRONTIER_MON_MIREIGOLD_2}, // 267 - 371
    {FRONTIER_MON_REINAGOLD_1,  FRONTIER_MON_SLAKING_1},  // 372 - 467
    {FRONTIER_MON_REINAGOLD_2,  FRONTIER_MON_SLAKING_2},  // 468 - 563
    {FRONTIER_MON_REINAGOLD_3,  FRONTIER_MON_SLAKING_3},  // 564 - 659
    {FRONTIER_MON_REINAGOLD_4,  FRONTIER_MON_SLAKING_4},  // 660 - 755
    {FRONTIER_MON_REINAGOLD_1,  FRONTIER_MONS_HIGH_TIER}, // 372 - 849
    ...
    {FRONTIER_MON_REINAGOLD_3, FRONTIER_MON_SLAKING_3}, // 564 - 659
    {FRONTIER_MON_REINAGOLD_4, FRONTIER_MON_SLAKING_4}, // 660 - 755
    {FRONTIER_MON_REINAGOLD_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_REINAGOLD_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_REINAGOLD_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_REINAGOLD_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
};
